...
**Release-Schnitt für 0.3.0 (01.09.2026):** Der nächste veröffentlichte Stand
ist die weiterhin kostenlose Demo **0.3.0**; eine Zwischenfassung 0.2.3 gibt es
nicht. Sämtliche Funktionen aus 0.2.2 bleiben erhalten und müssen mindestens
gleich gut funktionieren — mit genau einer ausdrücklich entschiedenen
Ausnahme: Der öffentliche, gehostete Austausch entfällt. Der lokale
Baustein-Export und -Import bleibt vollständig erhalten. Dieser Abschluss
nimmt keine neuen Funktionsblöcke auf und entfernt keine weitere Funktion.
Verkauf, Checkout und das breite Rechtsprogramm gehören nicht in 0.3.0: Sie
bleiben offen für das **1.0-Gate am 01.11.2026**. Die veröffentlichte
`website/version.json` bleibt bis zum tatsächlichen Upload bei 0.2.2.
...
| Entwurfsvermerk auf den Rechtstexten | Was erst am Verkaufsstart fällig wird (24.08.2026) | die fachliche Prüfung am 1.0-Gate zum 01.11.2026. Eine Zeile in `tools/make_legal.py:236` und ein Neuerzeugen — die drei HTML-Dateien von Hand zu ändern hielte bis zum nächsten Lauf. Nicht Teil der kostenlosen Demo 0.3.0 |
| Impressum ohne USt-IdNr. oder Steuernummer | Was erst am Verkaufsstart fällig wird (24.08.2026) | die Gewerbeanmeldung vor dem 1.0-Gate zum 01.11.2026. §5 TMG verlangt die Angabe, sobald es sie gibt; bis dahin ist sie nicht nachholbar und kein Mangel der kostenlosen Demo 0.3.0 |
...
| Die Versicherung trägt die Rechtsformentscheidung und steht in keiner Liste | Die Haftungsgrundlagen des Geschäftsmodells nachkontrolliert (24.08.2026) | ein Angebot vor dem 1.0-Gate zum 01.11.2026. Für Personen- und Sachschäden aus einem fehlerhaften Produkt braucht es eine **Produkthaftpflicht mit Software-Einschluss**, nicht nur die übliche Vermögensschadendeckung: Richtlinie (EU) 2024/2853 macht Software ausdrücklich zum Produkt. Kein Abschlusskriterium der kostenlosen Demo 0.3.0 |
| Der Haftungsausschluss der EULA wirkt nur mit einem Häkchen im Bestellvorgang | Die Haftungsgrundlagen des Geschäftsmodells nachkontrolliert (24.08.2026) | die Checkout-/Bestellstrecke für das 1.0-Gate zum 01.11.2026. `EULA.md` Nummer 10 — kein Prüfinstitut, keine zugesicherte Maßhaltigkeit, keine tragenden Teile — ist gegenüber Verbrauchern eine negative Beschaffenheitsvereinbarung und nach § 327h BGB **ausdrücklich und gesondert** zu vereinbaren. Betrifft nicht die kostenlose Demo 0.3.0; die PayPal-Spende hat keine Gegenleistung |
| Was der Zahlungsdienstleister vorn abnimmt, holt er hinten zurück | Die Haftungsgrundlagen des Geschäftsmodells nachkontrolliert (24.08.2026) | den Vertrag des Merchant of Record vor der Unterschrift am 1.0-Gate zum 01.11.2026. Er wickelt nur den späteren Lizenzkauf ab, nicht die kostenlose Demo 0.3.0 oder die PayPal-Spende. Seine Freistellung kann unbegrenzt und nach fremdem Recht gelten; `EULA.md` Nummer 11 wirkt gegenüber dem Kunden, nicht gegenüber dem Dienstleister. Bei einem Einzelunternehmen haftet dafür das Privatvermögen |
...
| 1.0-Verkaufsgate zum 01.11.2026 | Was Robert am 26.08.2026 aufgetragen hat | Finanzamt, Merchant of Record, Checkout, fachlich geprüfte Rechtstexte und der gesonderte Verkaufsbau mit `DEMO_UNTIL = None` und `TRIAL_FROM = None`. Dieser Gate-Entscheid ist ausdrücklich kein Teil der kostenlosen Demo 0.3.0 |
...
**Fortschreibung 01.09.2026:** Dieser Abschnitt dokumentiert den ursprünglichen
Demo-Schnitt, bestimmt aber nicht die nächste Versionsnummer. Der nächste
kostenlose Demo-Stand ist 0.3.0; 1.0 mit Verkauf folgt erst durch das gesonderte
Gate zum 01.11.2026.
...
**Aktueller Gate-Schnitt:** Diese Arbeiten bleiben offen für 1.0 am
01.11.2026. Sie sind weder Umfang noch Abnahmekriterium der kostenlosen Demo
0.3.0; deren Rechts- und Datenschutzpflichten bleiben davon unberührt.
...
Versicherung, Checkout und Merchant-of-Record-Vertrag bleiben offene Teile des
1.0-Gates zum 01.11.2026. Die kostenlose Demo 0.3.0 schließt sie nicht
stillschweigend ab; ihre bereits geltenden EULA-, Datenschutz- und
Produktsicherheitsauflagen bleiben trotzdem vollständig wirksam.
...
- [ ] **Die Versicherung trägt die Rechtsformentscheidung und steht in keiner
      ...
      **Produkthaftpflicht mit Software-Einschluss** — Richtlinie
      ...
      Umsetzungsfrist **09.12.2026**; das 1.0-Gate am 01.11.2026 liegt davor,
      die Absicherung bleibt trotzdem eine Voraussetzung des Verkaufs. Zu
      fragen ist auch, ob die Police Schäden aus KI-gestützten Ausgaben
      einschließt und wie sie den Fall behandelt, dass ein Kunde sich **nicht**
      an Nummer 10 hält.
...
- [ ] **1.0-Verkaufsgate zum 01.11.2026.** Finanzamt, Merchant of Record,
  Checkout, fachlich geprüfte Rechtstexte und der gesonderte Verkaufsbau mit
  `DEMO_UNTIL = None` und `TRIAL_FROM = None` werden gemeinsam abgenommen. Das
  ist kein Serverschalter — beide Werte sind einkompiliert, und der
  Update-Hinweis braucht eine Woche Vorlauf. Nichts davon wird mit der
  kostenlosen Demo 0.3.0 als fertig behauptet.
...
- [~] **Resin Stufe 1: entschieden und beratschlagt — bauen, als
      ...
      nicht Teil von 0.3.0, sondern ein eigener späterer Zyklus mit
      Paketschnitt bei Serienstart.
...
**Verbindliche Produktentscheidung zu T1:** Der öffentliche, gehostete
Austausch ist für 0.3.0 gestrichen. Es gibt keine Galerie für
Nutzereinreichungen, keine Uploads oder Serverdownloads, keine Likes,
Kommentare, Profile, Konten, Moderation oder Bestätigungsmails. Vollständig
erhalten bleibt ausschließlich der lokale, verlustfreie Baustein-Export und
-Import mit Autor, Lizenz, Herkunft, Größen-/Integritätsprüfung und ohne
ausführbaren Quelltext. Das ist die einzige beschlossene Funktionsentfernung
gegenüber 0.2.2 und kein offener Produktfehler oder neuer Funktionsblock.
...
| T2 | Stützbedarf je Teilstück in die Bewertung: die besten Kandidaten je Ebene grob orientieren (`orient_for_print`) und das Stützvolumen der Schichtanalyse in den Score mischen — beide Bausteine existieren | M–L | **zu** (`f230ce89`, zentral reviewt): Unter den guten Nähten entscheidet jetzt das gemessene Stützvolumen beider einzeln grob orientierter Hälften; die gewählte Verbindergeometrie gehört bereits zu dieser Bewertung. Ein vor dem Arbeiter erfasster `ConnectorGeometrySnapshot` hält die Rangfolge trotz parallel geladener eigener Bausteine reproduzierbar. Der Oberflächenweg wartet revisionsgebunden über `_PendingSplit` auf das aktuelle Netz, ohne den Qt-Hauptthread mit `wait_for_idle()` anzuhalten; bei unbekannter Gesamtschnittzahl bleibt die Anzeige ehrlich unbestimmt. Abbruch ändert Dokument und Verlauf nicht, ein Rückgängig stellt den 400 × 30 × 10-mm-Ausgangskörper vollständig wieder her, und ein fehlender Schnitt bietet die gezeichnete Linie an. Exakt auf dem Commit-Tree grün: 327 Kernprüfungen, 17 Lebenszyklusfälle, 199 Anschlussprüfungen, Ruff, Format und Mypy sowie der native Windows-Ablauf bei 640 × 720 bis 1920 × 1080 und großer Schrift. Der 200.000-Dreieck-Fallback lag bei 9,47 s und damit unter §31. |
