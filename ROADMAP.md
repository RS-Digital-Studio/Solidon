...
| `decimate_mesh` erzeugt bei starker Reduktion nicht-mannigfaltige Kanten | Drei Netzbefunde aus dem Weg-3-Dreh (31.08.2026) | eine Ursachen-Untersuchung im Reduzierer — die Schwellen sind gemessen (100 000 sauber, 60 000 zwei, 30 000 vier defekte Kanten), der Prüfbericht meldet korrekt |
| Der Meldungs-Zirkel zwischen `repair` und `remesh_uniform` | Drei Netzbefunde aus dem Weg-3-Dreh (31.08.2026) | einen Handlungsvorschlag, der nicht zurückführt — zwei Meldungen zeigen aufeinander, der Nutzer läuft im Kreis |
| `repair` meldet Vollzug ohne Zahl | Drei Netzbefunde aus dem Weg-3-Dreh (31.08.2026) | Anteil und Rest in der Meldung („vierzehn von zwanzig geschlossen"), statt Vollzug zu behaupten |
...
## Drei Netzbefunde aus dem Weg-3-Dreh (31.08.2026)
