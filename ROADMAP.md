...
| V9 | Doku und Testlücke: Regeltexte sagen acht Werkzeuge, es sind sieben (ein Platz ist frei!); und `start=` hat keinen Test — einer, der jedes Werkzeug öffnet und den arbeitenden Zustand prüft, hätte V1 und V4 gefangen | S | **50, beauftragt** — kennt beide Fälle aus erster Hand |
