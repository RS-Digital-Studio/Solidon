...
| Die Zeilen laufen auf vier Seiten zu lang | Die Zeilen laufen zu lang (31.08.2026) | eine Absatz-genaue Messung vor dem Bau (echter Fließtext gegen bewusst breite Elemente) und die Abstimmung 15↔50 — die Startseite trägt Karten und Spalten, eine Pauschalgrenze bräche Layouts |
...
- [ ] **Fließtext auf Lesebreite bringen, ohne Karten-Layouts zu brechen.**
      Zuerst Absatz-genau messen, was echter Fließtext ist und was in einem
      Element steht, das aus gutem Grund breit ist; dann die Grenze setzen.
      Gemeinsame Arbeit 15↔50 — die Startseite gehört beiden.
