...
- [ ] **Nur noch Z6b:** Der Rechteck-Knopf trägt am Bildschirm keinen
      Namen (Symbol+Pfeil; `text()` sagt „Rechteck", sichtbar ist es nicht) —
      wer die Leerzustands-Einladung liest statt klickt, sucht weiter.
      Entscheidung über die Form (Text am Knopf gegen Leistenbreite) nach
      Messung. Ursprünglich: Die neun Z-Pakete abarbeiten — Z1 zuerst; je Paket Zahlen,
