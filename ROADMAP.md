...
| G10 | Leere- und Wartezustände: **B17 ist zu** (`aeb74155`) — über der leeren Chat-Liste steht ein Satz, der den Ort erklärt und mit dem ersten Zug verschwindet; die Modellzeile steht zuletzt statt zuoberst, und der Test misst die Reihenfolge im Layout, nicht nur die Sichtbarkeit. Offen: B18 (Generierungsdialog), B26 (Freischaltung), B29 (vier nackte Wartezeilen) | M | **72, läuft** |
