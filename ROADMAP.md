...
| Z2 | Ein Maß ändern kostet 8 Klicks über Lösen-und-neu-Legen (Fusion: Doppelklick auf die Zahl) — „Maß ändern …" im Kontextmenü und per Doppelklick auf die Listenzeile, Entfernen+Neusetzen in EINEM Undo-Schritt | M | **50, beauftragt** — dazu der V9-Doku-Nachzug (Regeltexte: acht Werkzeuge, es sind sieben) |
