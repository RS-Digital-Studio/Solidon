...
| Die Chat-Grundlast frisst drei Viertel des Fensters vor dem ersten Objekt | Der Chat-Kontext ist nach einem Objekt zu drei Vierteln voll (30.08.2026) | ein Paket „kompakte Werkzeugschemata" — die Messreihe ist durch (74 % Grundlast, ~600 Token je Zug, ~14–15 Züge Tragweite), die Stellschraube ist benannt; **in Arbeit bei d3 (zugeteilt 31.08., auf eigenen Vorschlag)** |
