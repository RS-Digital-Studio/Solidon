...
| V6 | Ein angeklickter Befund fliegt an eine Stelle ohne Marke (alle op.*-Befunde): vergänglicher Ring in Auswahlfarbe plus Befundtitel, `_ring_points` existiert | M | **3a, beauftragt** — Nachmessung am gebauten Fenster vor dem Bau, Befunde altern |
