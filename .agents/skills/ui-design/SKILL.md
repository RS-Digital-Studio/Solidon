...
Bestimme die konkrete Ansicht und das Nutzerziel. Lies `.agents/skills/bauplan/SKILL.md` für den
...
werden zusätzlich mit `.agents/skills/ux-review/SKILL.md` geprüft.
...
Website-Abnahme über `.agents/skills/website-review/SKILL.md`; App-Sichtprüfung am echten Fenster
...
über `.agents/skills/erzeugen/SKILL.md` neu erzeugen; Review-Belege außerhalb des Auslieferungspfads.

Bei Codeänderungen betroffene Tests über `.agents/skills/pruefen/SKILL.md` mit Dateipfaden ausführen.
