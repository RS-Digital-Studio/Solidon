...
Grenze Operation, Eingaben und erwartetes Ergebnis ein. Lies über `.agents/skills/bauplan/SKILL.md`
...
Lasse die betroffenen Tests über `.agents/skills/pruefen/SKILL.md` mit ausdrücklichen Dateipfaden
