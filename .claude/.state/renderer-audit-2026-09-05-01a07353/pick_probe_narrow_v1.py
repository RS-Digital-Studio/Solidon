...
results = {"index": args.index, "renderer": args.renderer, "phase": args.phase,
    ...
    "probe_files_sha256": {name: hashlib.sha256((ROOT/name).read_bytes()).hexdigest()
        for name in ("probe.py", "probe_template.py", "probe_helpers.py.inc", "helper-pins.json", "menu_driver.py", "feature_checks.py", "general_checks.py", "analysis_checks.py", "run_context.py", "gesture_checks.py")},
