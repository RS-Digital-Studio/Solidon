...
Am 06.09.2026 startete ich `suite…; echo Exit; pytest -m performance` als
Hintergrundaufgabe, entschied dann, den Lauf
...
und startete das zweite Glied: Die Leistungstests liefen los, unter einer
neuen Prozessnummer, die niemand erwartet hatte.
...
mit `&&` bauen, damit ein gekilltes Glied sie abbricht. Danach die
Prozessliste lesen und die Nummer mit der eigenen vergleichen.
