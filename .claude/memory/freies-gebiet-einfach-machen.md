...
vorgelegt: eine Zeile für die Fallenliste in `CLAUDE.md` und eine Behebung in
`.claude/.state/.../suite-getrennt.sh`. Seine Antwort: „immer machen wenn es
frei ist."
...
`.claude/**`) für grundsätzlich vorlagepflichtig gehalten; das sind sie nicht.

**How to apply:**

- **Frei heißt frei.** Gehört die Datei zur Aufgabe, wird gearbeitet — auch
  `CLAUDE.md`, `AGENTS.md` und `.claude/**`.
