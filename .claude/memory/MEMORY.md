...
- [Fusion ist da](zeichnen-an-fusion-orientieren.md) · [Slicer sind da](slicer-lokal-zum-gegenmessen.md) · [Live-Durchsicht 08/2026](live-durchsicht-solidon3d-2026-08.md) · [Downloads als 3MF-Korpus](downloads-ordner-als-3mf-korpus.md) — Vergleichswerkzeuge lokal; sechzehn echte 3MF für den Leser.
...
- [Ungenutzter Import reißt den Prozess](ungenutzter-import-reisst-den-prozess.md) — `QMouseEvent` in labels.py, ungenutzt, 0xc0000374 im gc; Importzeilen als eigene Bisektionskandidaten.
