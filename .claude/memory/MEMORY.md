...
- [Geteilter Index nach fremdem Commit veraltet](geteilter-index-nach-fremdem-commit-veraltet.md) — `git diff --cached --stat` vor jedem Commit; Phantom-Löschungen heilt `git reset -q`; Index nur gegen einen HEAD bauen, numstat-Gegenprobe.
