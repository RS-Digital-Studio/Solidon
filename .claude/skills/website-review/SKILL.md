...
beauftragten Commit stehen in `/pruefen`.
...
die Release-Bilderzeugung aus `/erzeugen` ist dafür nicht erforderlich.
...
Browserablauf. Für veränderte erzeugte Artefakte gilt `/erzeugen`. Offen
