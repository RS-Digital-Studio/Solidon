...
Lies den einschlägigen Bauplan über `/bauplan`, die Lizenzregeln in `AGENTS.md`
...
`test_licence_notices.py`; Ablauf und Ergebnisnachweis über `/pruefen`.
...
Seiten über `/erzeugen` aktualisieren. Ungeklärte Tatsachen nicht in Vertragstext
