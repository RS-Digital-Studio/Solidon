...
den tatsächlichen Dateien abgleichen. Prüfbilder aus `/website-review` sind
...
Vor dem Paketbau gilt das vollständige Tor über `/pruefen`. Die CI ist der
...
6. `upload_website.py --nachpruefen` gegen den Server ausführen. Lokale Dateien
   ...
   Bei visuellen Änderungen zusätzlich `/website-review` auf den Zielseiten.
