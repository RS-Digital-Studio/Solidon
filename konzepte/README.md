...
|---|---|---|---|
| [konzept-aktivierungsserver-2026-08.md](konzept-aktivierungsserver-2026-08.md) | 26.08. | Aktivierungsserver, Kauffluss, Widerruf | **Entwurf, alle vier Teile ausgearbeitet, Abnahme durch Robert offen** — nichts davon gebaut. Vier Teile aus vier Sitzungen: Kern (Zertifikat, Zufalls-ID, vorläufige Freischaltung), Server/Kauf/Recht, Sicherheit (vier Gegner, gedeckelter Einbruchsschaden, Widerruf mit Datum), Bedienung (der Freischaltdialog bleibt der eine Ort). Der Befund des Tages steht in B2: Einen eigenen Schlüsselvorrat liefert kein empfohlener Zahlungsanbieter mehr nativ aus — der Kauf braucht denselben Webhook-Endpunkt, den die Aktivierung ohnehin bringt. Elf Entscheidungen für Robert am Ende |
...
| [konzept-foerdermodell.md](konzept-foerdermodell.md) | 23./24./**28.08.** | Monatliche Förderung in drei Stufen, Einmalspende, Rechtsform, Kontrolle aller Rechtstexte | **Weitgehend entschieden, eine Frage offen.** Am 28.08. gegen vier Festlegungen Roberts fortgeschrieben (§16): Beträge **5 / 10 / 15 €** plus freier Betrag, **kein Lizenzschlüssel in einer Förderstufe** mehr, dazu eine **Einmalspende** — und damit fällt die ganze Lückenrechnung aus §3 weg. Der harte Befund des Tages steht in §16.4: **Ein Merchant of Record kann die Förderung nicht abwickeln**, weil Zuwendungen ohne Produkt vertraglich ausgeschlossen sind (Lemon Squeezy führt sie in der Liste verbotener Produkte). Es braucht zwei Anbieter — Lemon Squeezy für den Kauf, eine Förderplattform daneben. Offen bleibt genau eine Frage, und sie ist die für den Steuerberater (§16.5): **ab wann ist ein Dank eine Gegenleistung** — daran hängt, ob der Anbieter ohne MoR trägt. Von sechs Punkten in §13 ist einer offen (§16.7). Die Feststellung, auf der alles steht, ist unverändert: Ein Zugang auf Zeit ist nicht baubar, weil ein Schlüssel kein Ablaufdatum trägt (`key.py:90`) und es keinen Server gibt, der widerrufen könnte — **seit §16 ist das kein Hindernis mehr, sondern gegenstandslos.** Drei Rechtstext-Befunde sind behoben (ODR-Verweis, Muster-Widerrufsformular, Präsens-Behauptung im Datenschutztext). **§14 altert schnell** — es beschreibt fünf Tage, von denen einer 91 % trägt, und seine geschätzte Kaufrate ist ab dem 01.11.2026 messbar (§16.8). **§15 kontrolliert die Haftungsgrundlagen nach** (24.08.): acht Befunde, fünf davon als Punkte im Register — zwei Sätze der EULA tragen nicht, was §5 auf sie baut, und einer davon gilt heute schon, weil `AGB.md` sich für die Demo-Zeit selbst außer Kraft setzt |
