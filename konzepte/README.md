...
|---|---|---|---|
| [konzept-foerdermodell.md](konzept-foerdermodell.md) | 23.08. | Monatliche Förderung in drei Stufen, Rechtsform, Kontrolle aller Rechtstexte | **Entscheidung offen** — §13 nennt fünf Punkte, die Robert gehören. Der Kern ist eine Feststellung, keine Frage: Ein Zugang auf Zeit ist nicht baubar, weil ein Schlüssel kein Ablaufdatum trägt (`key.py:90`) und es keinen Server gibt, der widerrufen könnte. Zwei Befunde der Rechtstext-Durchsicht sind sofort behoben (ODR-Verweis, Muster-Widerrufsformular), drei liegen als Entscheidung vor |
