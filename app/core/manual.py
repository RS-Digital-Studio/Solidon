...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "und die Prüfkörper aus dem vorigen Kapitel — "
            "dreiundzwanzig in sechs Gruppen. Der Katalog zeigt zu jedem ein Bild — eine "
    ...
    Page(
        ...
        body=_(
            ...
            "**Der Weg beginnt im Bausteinkatalog**, nicht in einem Menü: "
            "*Auswahl als Baustein speichern*. Was Sie gebaut haben, wird "
            ...
            "**Der Dialog fragt vier Dinge.** Einen Namen, unter dem der "
            "Baustein im Katalog steht. Eine Gruppe, in die er einsortiert "
            "wird. Zu jedem Parameter, ob er einstellbar sein soll — mit "
            ...
            "**Ändern heißt neu speichern.** Ein Rezept hat eine Fassung, die "
            "sich aus seinem Inhalt ergibt. Öffnen Sie später ein Projekt, "
            "das eine ältere benutzt hat, sagt es Ihnen das — und Sie "
            "entscheiden, ob Sie mitgehen. Ändert sich nichts, sagt auch "
            "niemand etwas."
        ),
    ),
    Page(
