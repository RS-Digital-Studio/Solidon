...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "**In der Mitte** das Modell. Linke Maustaste wählt aus, rechte "
            "dreht, mittlere schiebt — ebenso Umschalt und Ziehen —, und das "
            "Mausrad zoomt dorthin, wo der Zeiger steht. Wer es aus einem "
            "anderen Programm anders gewohnt ist, stellt in den Einstellungen "
            "auf CAD- oder Blender-Belegung um; dort dreht dann die mittlere "
            "Taste. Eine 3D-Maus (SpaceMouse) fährt dieselbe Kamera, sobald sie "
            "eingesteckt ist: Die Kappe ist das Teil — Schieben verschiebt es, "
            "Drehen dreht es, zu sich ziehen holt es näher, und eine Gerätetaste "
            "passt alles ein. Geschwindigkeit und Richtung stehen in den "
    ...
    Page(
        ...
        body=_(
            ...
            "*Bewegen* aus der Werkzeugleiste und **Färben** aus dem Menü. "
            "Beide halten das Versprechen des Verlaufs — jeder Zug und jede "
            "Zuweisung ist ein eigener Schritt, den Strg+Z einzeln "
            "zurücknimmt.\n\n"
            "**Bewegen** zeigt den Griff im Bild: drei "
            "Pfeile zum Verschieben, drei Ringe zum Drehen, ein Würfel zum "
            "gleichmäßigen Skalieren — beschriftet mit X, Y, Z und S. "
            "**Wer lieber tippt als zieht, tippt.** Drei Knöpfe in der "
            "Leiste wählen, worum es geht — *Verschieben*, *Drehen*, "
            "*Skalieren* —, und daneben stehen die Zahlen dazu: X, Y, Z in "
            "Millimetern, ein Winkel in Grad, ein Faktor in Prozent oder "
            "gleich das Zielmaß. *Anwenden* macht daraus denselben Schritt, "
            "den auch ein Zug erzeugt. Beim "
            ...
            "heißt: kein Einrasten. Beide liegen hinter dem Knopf mit dem Raster.\n\n"
            ...
            "*Teil färben* nimmt den ganzen Körper, *Fläche färben* genau "
            "die Fläche, auf die man zeigt. Für eine Fläche ist der kürzeste "
            "Weg der Rechtsklick darauf — der Dialog kennt sie dann schon.\n\n"
            "Gewählt wird ein **Filament**, keine Nummer: mit Namen und Farbe, "
            "aus dem eigenen Katalog oder gleich neu angelegt. Ganz oben "
            "steht, was der Körper schon trägt — meistens ist das die "
            "Antwort. Beim 3MF-Export wird daraus der Filamentwechsel für "
            "den Drucker; ein Teil ohne eigenes Filament behält die Farbe "
            "des Körpers.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "**Sehen, wählen, ziehen.** Es gilt dieselbe Belegung wie im "
            "Hauptfenster: die rechte Maustaste dreht, die mittlere schiebt "
            "wie Umschalt und Ziehen, das Mausrad zoomt dorthin, wo der "
            "Zeiger steht. "
    ...
    Page(
        ...
        body=_(
            ...
            "gewählten Körper bleibt der Katalog gesperrt und sagt, woran es "
            "liegt — durchsehen lässt er sich trotzdem.\n\n"
