...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "`A`, Punkt `P`, Kurve `S`, Vieleck `V`, Langloch `G`, Trimmen "
            "`T`. Vieleck und Langloch entstehen aus je zwei Klicks: Mitte "
            "und Ecke beim Vieleck, die Mitten der beiden runden Enden beim "
            "Langloch; Eckenzahl und Breite stehen daneben in der Leiste. "
            "Die Ziffern `1`, `2` "
            "und `3` wechseln direkt zwischen XY, XZ und YZ. `Esc` schaltet zurück "
            "aufs Auswählen und bricht ein angefangenes Element ab. Die Linie "
            "läuft als Zug weiter — das Ende ist der Anfang der nächsten. Eine "
            "Kurve sammelt, bis Sie sagen, dass sie fertig ist: Doppelklick, "
