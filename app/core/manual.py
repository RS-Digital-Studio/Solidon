...
INTRODUCTION: Final[tuple[Page, ...]] = (
    Page(
        ...
        body=_(
            ...
            "Konto, keine Telemetrie. Von sich aus meldet sich Solidon nur beim "
            "Start, um nach einer neueren Fassung zu fragen — sie nennt dabei "
            "nichts als die eigene Versionsnummer, und in den Einstellungen "
    ...
    Page(
        ...
        body=_(
            ...
            "![](figure:window)\n\n"
            "**Die Projektkopfzeile** nennt den Projektnamen, den Drucker und die "
            "tatsächlich verwendeten Filamente. Ein Klick auf den Drucker öffnet "
            "seine Auswahl für dieses Projekt; hat das Projekt mehrere Platten, "
            "steht neben dem Druckernamen der Plattenwähler, der die Ansicht "
            "auf eine davon stellt. Unterschiedliche Materialien und "
            "Farben werden den einzelnen Körpern oder Flächen zugeordnet.\n\n"
            "**Oben die Werkzeugleiste:** Neu, Öffnen, Speichern, *Modell "
            "einfügen*, *Zeichnen* — das die Ansicht senkrecht auf die "
            ...
            "meisten davon sehen nur hin; *Bewegen* und *Trennen* "
            "ändern das Modell wirklich, und beide tun es als Schritt im "
            "Verlauf.\n\n"
            "**Links** liegen Objekte, Parameter, Verlauf und Filamente "
            "untereinander, jeder Abschnitt einklappbar. Der Objektbaum zeigt, "
            "was in der Szene steht — und unter jedem Körper, was die Erkennung "
            "darin gefunden hat; die Parameterliste die benannten Maße des "
            "Projekts; der Verlauf jeden Schritt, der zum aktuellen Stand "
            "geführt hat. *Filamente* steht zugeklappt da: Welche Spulen im "
            "Regal liegen, fragt man einmal am Anfang und einmal vor dem "
            "Drucken.\n\n"
            "**In der Mitte** das Modell. Links ziehen verschiebt die Ansicht, "
            "links klicken wählt aus — wer die Maus bewegt, schiebt, wer nur "
            "tippt, wählt. Ist ein Körper gewählt und Sie drücken links auf "
            "ihm, bewegen Sie den Körper; daneben die Ansicht. Rechts ziehen "
            "dreht um die Mitte der Ansicht, das gedrückte Mausrad kippt nach "
            "oben und unten, und Scrollen zoomt dorthin, wo der Zeiger "
            "steht.\n\n"
            "**Und die Tastatur fliegt.** W und S fahren vorwärts und "
            "rückwärts, A und D seitwärts, Q und E kippen wie das gedrückte "
            "Rad. Halten Sie die Taste — die Ansicht fliegt gleichmäßig, "
            "solange sie liegt; wer A und D zugleich hält, steht still, denn "
            "die Richtungen heben sich auf. Der Unterschied zum Zoom: Der "
            "fährt bis vor das Teil, der Flug geht hindurch. Die Tasten kommen "
            "erst an, wenn die Ansicht den Fokus hat — ein Klick hinein "
            "genügt; wer aus einem Eingabefeld kommt und gleich W drückt, "
            "schreibt ein W. Verliert die Ansicht den Fokus, hält der Flug "
            "an.\n\n"
            "**Wer es anders gewohnt ist, stellt um.** In den Einstellungen "
            ...
            "sobald ein Gerät gesehen wurde.\n\n"
            "**Pos1 rückt die Kamera zurecht.** *Einpassen* rahmt den Körper, "
            "den Sie gewählt haben — und ohne eine Auswahl die ganze "
            "Szene.\n\n"
            "**Daneben zwei Reiter:** *Prüfbericht* und *Chat* — nie beides "
            "nebeneinander, weil beides gleichzeitig niemand liest. Entsteht "
            "eine Warnung, springt die Ansicht von selbst auf den Bericht. "
            "Gleiche Meldungen fasst er zu einer Zeile zusammen, die Zahl steht "
            "in Klammern davor; ein Klick darauf wählt alle betroffenen Teile, "
            "und eine Handlung fragt, für welche davon sie gelten soll. Beim "
            "Zeichnen kommt ein Reiter für die Bedingungen der Skizze dazu, in "
            "der Einführung einer für die Tour. Ein Tastendruck blendet die "
            "ganze Spalte aus, dann ist das Modell im Vollbild.\n\n"
            "**Ganz rechts steht das Auswahlfenster**, über die volle Höhe, "
            "sobald Sie etwas gewählt haben: oben die Maße dessen, was Sie "
            "angeklickt haben, darunter die Handlungen dazu. Vorn stehen die, "
            "die zur Auswahl passen: bei zwei Körpern *Vereinigen*, *Abziehen* "
            "und *Schnittmenge*, bei einem einzelnen *Bohrung setzen*, "
            "*Aushöhlen* und *Teilen*, an einer angeklickten Bohrung *Senken* "
            "und *Bohrung verschließen* — *Bohrung ändern* und *Zum Langloch "
            "ziehen* stehen darüber schon als Felder mit den gemessenen Werten. "
            "Alle weiteren stehen darunter in Gruppen, die sich zuklappen "
            "lassen, und ein Suchfeld findet jede über ihren Namen. Der Knopf "
            "*Bausteine* am Ende — in der Akzentfarbe, damit er auffällt — "
            "öffnet den Katalog. Das Fenster lässt sich abziehen und woanders "
            "hinstellen, und *Ansicht → Auswahl* blendet es aus. Was darin "
            "steht, sagt das Kapitel über die Merkmale.\n\n"
            "**Ein Menü für die Auswahl gibt es deshalb nicht.** Was einem "
            "gewählten Körper oder Merkmal gilt, steht rechts und nirgends "
            "sonst; die Menüleiste behält, was ohne Auswahl geht — Datei, "
            "Bearbeiten, Erzeugen, Ansicht, Hilfe. Die Tastenkürzel gelten "
            "weiter, und die Befehlspalette findet jede Handlung nach wie "
            "vor.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "man muss also nicht treffen, sondern nur in die Nähe kommen. "
            "Solange gemessen wird, zeigt die Ansicht ohne Perspektive, wie "
            "eine Zeichnung — perspektivisch zielt man daneben, je weiter die "
            "Strecke von der Bildmitte weg liegt —, und danach schaltet sie "
            "zurück. Für "
            ...
            "Druckbarkeit. **Netzfehler** zeigt offene Kanten, Stellen, an "
            "denen mehr als zwei Flächen zusammenstoßen, und Flächen, die "
            "einander durchdringen — dort sitzt fast immer die Ursache, wenn "
            "eine Verknüpfung scheitert. "
            "**Merkmale** färbt, was die Erkennung aus dem Körper "
            ...
            "in Schichten zerfällt. Bei einem einzelnen Körper beginnt sie "
            "sofort; bei mehreren wählen Sie zuerst den Körper, den Sie "
            "untersuchen wollen. Der Regler fährt hindurch. Daneben stehen "
            "Schichtnummer und Gesamtzahl, Z-Höhe, Querschnittsfläche, Zahl "
            "der Inseln und Überhangfläche. Die Legende unterscheidet Kontur, "
            "Insel und Überhang zusätzlich zur Farbe. Was Sie sehen, ist "
            "Solidons eigene Schichtanalyse und **nicht** das, was der Slicer "
            "später rechnet. Beide Zahlenwelten bleiben getrennt ausgewiesen, "
            "damit niemand eine Schätzung für eine Messung hält.\n\n"
            "![](figure:layers)\n\n"
            ...
            "unberührt.\n\n"
            "**Auch der Schatten unter dem Modell sagt etwas.** Er fällt für "
            "jedes Stück einzeln, nicht für den ganzen Körper — ein Teil, das "
            "beim Rechnen in mehrere Stücke zerfallen ist, wirft deshalb "
            "mehrere Schatten, bevor man das im Netz selbst sieht.\n\n"
    ...
    Page(
        key="features",
        summary=_(
            "Was Solidon in einem geladenen Modell wiedererkennt, und was ein Klick "
            "darauf möglich macht."
        ),
        title=_("Was Solidon im Modell erkennt"),
        body=_(
            "Eine STL-Datei enthält Dreiecke und sonst nichts. Keine Bohrung, "
            "kein Radius, kein Maß — wer ein heruntergeladenes Modell öffnet, "
            "hat eine Hülle aus zehntausend Flächen vor sich, und die weiß von "
            "der Bohrung nichts, die jemand einmal konstruiert hat.\n\n"
            "Solidon liest sie zurück. Nach dem Laden geht eine Erkennung über "
            "den Körper und passt Formen in seine Flächen: Zylinder, Kegel, "
            "Kugeln, Ringe, Rundungen. Was passt, wird ein **Merkmal** — mit "
            "Mitte, Achse, Maß und einer Kennung, die bleibt. Von da an ist die "
            "Bohrung wieder eine Bohrung und nicht mehr ein Ring aus "
            "Dreiecken.\n\n"
            "**Zwölf Arten, und der Name sagt die Lage:**\n\n"
            "* **Bohrung** — ein Zylinder, der hineingeht. Sie werden "
            "durchnummeriert: „Bohrung 1“, „Bohrung 2“.\n"
            "* **Langloch** — zwei runde Enden und zwei gerade Flanken. Es "
            "steht als eines da und nicht als zwei Rundungen; Breite und Länge "
            "stehen dabei.\n"
            ...
            "* **Lufteinschluss** — ein Hohlraum mitten im Material, ohne Weg "
            "nach außen. Beim Drucken bleibt dort Luft; ob das gewollt ist — "
            "etwa eine Tasche für einen eingegossenen Magneten — oder ein "
            "vergessener Rest, weiß nur, wer das Teil gezeichnet hat.\n"
            "* **Offene Kante** — kein Körperteil, sondern ein Loch im Netz. Sie "
            "steht in derselben Liste, weil sie an derselben Stelle sitzt und "
            "repariert werden will.\n"
            "* **Fläche** — benannt nach ihrer Richtung: „Oberseite“, "
            "„Vorderseite“, „Rechte Seite“. Eine nach innen zeigende Wand "
            "heißt „Oberseite innen“ — sonst hieße die Innenseite einer Dose "
            "genauso wie ihr Deckel.\n"
            "* **Gerundete Seite** — ein gebogenes Stück der Oberfläche ohne "
            "eigene Ebene: der Bogen eines D, der Mantel eines o. Sie nimmt ein "
            "eigenes Filament an; bohren, zeichnen und versetzen lässt sich auf "
            "ihr nicht, denn dafür braucht es eine Ebene.\n\n"
            "Wo zwei Namen stehen, entscheidet die Richtung: Dieselbe Rundung "
            "heißt an einer Innenecke Hohlkehle und an einer Außenkante "
            "Verrundung. Die Liste steht im Objektbaum unter dem Körper, "
            "gleichartige unter einem Dach.\n\n"
            "**Zu kleine Formen werden nicht geführt.** Unter einem halben "
            "Millimeter Durchmesser gilt nichts als Merkmal — kleiner kann kein "
            "Drucker es herstellen. An einem echten Kundenmodell fielen damit "
            "296 von 1130 Einträgen weg, darunter Rundungen mit sieben "
            "Zehntausendstel Millimeter Radius. Das sind keine Merkmale, das ist "
            "die Auflösung des Dreiecksnetzes, und eine Liste, die zu einem "
            "Viertel daraus besteht, ist keine Liste, sondern Rauschen.\n\n"
            "**Und auf einer überwiegend gekrümmten Oberfläche werden vier "
            "Arten weggelassen.** Eine gebogene Fläche passt örtlich immer auf "
            "eine Kugel; ein gescanntes Teil oder eine Figur trüge damit "
            "Hunderte Kuppeln und Pfannen, die nichts bezeichnen. Kugeln, "
            "Ringe, Kegel und Verrundungen bleiben dort draußen, Bohrungen, "
            "Zapfen und ebene Flächen bleiben drin — und der Prüfbericht sagt "
            "es. Er nennt, was gemessen wurde, nicht woher das Teil kommt: "
            "Auch ein konstruierter Halter mit geschwungenem Bogen fällt "
            "darunter.\n\n"
            "## Das Auswahlfenster\n\n"
            "Wer etwas anklickt — im Bild oder im Objektbaum —, findet seine "
            "Maße im Fenster *Auswahl*. Es steht ganz rechts und über die "
            "volle Höhe — nicht als Karte unter dem Prüfbericht, sondern als "
            "eigenes Fenster daneben. Abziehen und woanders hinstellen lässt es "
            "sich auch, und *Ansicht → Auswahl* blendet es ganz aus. Es folgt "
            "der Auswahl und leert sich, wenn keine besteht.\n\n"
            "**Ein Ort, eine Antwort.** Bis zur Fassung 0.3.5 standen die "
            "Handlungen zur Auswahl in einer eigenen Karte über der Ansicht und "
            "die Maße hier — an einer angeklickten Senkung fanden Sie dieselben "
            "drei Handlungen zweimal, einmal als Knöpfe und einmal als Felder. "
            "Sie stehen jetzt zusammen: oben die Maße, darunter die "
            "Handlungen.\n\n"
            "Oben steht, was gemessen wurde: „Bohrung 1 · Ø 5,19 mm“, und bei "
            "einer Bohrung eine Zeile dazu, welche Normgröße das ist — 5,19 mm "
            "ist das Durchgangsloch für M5. Darunter stehen die Handlungen, je "
            "eine Gruppe aus Feldern, und unten ein einziger Knopf "
            "*Übernehmen*: Er führt die Handlung aus, deren Felder Sie zuletzt "
            "angefasst haben, und welche das ist, steht über ihm.\n\n"
            "**Die Felder stehen auf den gemessenen Werten.** Das ist der ganze "
            "Gedanke dahinter: Eine geänderte Zahl ist die Operation. Wer die "
            "Bohrung zwei Millimeter weiter rechts haben will, ändert die eine "
            "Zahl, die er meint, und lässt die anderen stehen. Eine Vorgabe, die "
            "nicht der gemessene Wert wäre, würde beim ersten Klick etwas "
            "ändern, das niemand ändern wollte.\n\n"
            "**Eine geänderte Zahl zeigt sich, bevor sie gilt.** Das Bild zeigt "
            "die Vorschau, sobald das Tippen kurz ruht; erst *Übernehmen* macht "
            "daraus einen Schritt im Verlauf.\n\n"
            "**Wer lieber zeigt als tippt, nimmt den Knopf darüber.** *Im Bild "
            "einstellen* steht über *Übernehmen*, sobald die Handlung eine Stelle "
            "auf einer Fläche hat. Das Loch bekommt dann im Bild einen Griff zum "
            "Versetzen und Drehen, Knöpfe zum Ziehen und Maßlinien zu den "
            "Kanten und zur Mitte der Fläche; jedes Maß lässt sich dort auch "
            "eintippen. Ein gezogenes Langloch zeigt dabei seine Länge und "
            "behält seine Form, wenn Sie es am Griff versetzen. Erst "
            "*Übernehmen* rechts macht daraus einen Schritt; *Abbrechen* "
            "darunter oder Escape verwirft, was im Bild wartet.\n\n"
            "**Ein leeres Koordinatenfeld heißt: Das Loch bleibt, wo es ist.** "
            "Bei *Bohrung ändern* und *Zum Langloch ziehen* stehen X, Y und Z "
            "auf „wie gemessen“, solange Sie nur das Maß ändern wollen. Eine "
            "eingetragene Zahl ist eine neue Stelle — auch die Null. So kommt "
            "ein Loch genau in die Mitte des Teils.\n\n"
            "**Sechs Handlungen gibt es**, und welche davon dasteht, hängt von "
            "der Art ab:\n\n"
            "* *Merkmal verschieben* — die neue Mitte als X, Y, Z.\n"
            "* *Bohrung ändern* beziehungsweise *Merkmal ändern* — der neue "
            "Durchmesser. Bei einer Bohrung wird die Materialtoleranz dabei "
            "mitgerechnet; bei einem Langloch ist es die Breite, und die Enden "
            "wachsen mit.\n"
            "* *Zum Langloch ziehen* — Länge und Richtung. An einer runden "
            "Bohrung steht in der Länge das Doppelte ihres Durchmessers: ein "
            "Langloch, in dem sich die Schraube um einen Durchmesser "
            "verschieben lässt. An einem Langloch stehen seine gemessene Länge "
            "und seine Richtung — länger geht, kürzer nicht, und die Richtung "
            "bleibt, wo sie war, solange Sie sie nicht ändern. Die "
            "Materialtoleranz weitet das Langloch über die ganze Länge; der "
            "Weg, den die Schraube darin hat, bleibt der eingegebene.\n"
            "* *Merkmal drehen* — Achse und Winkel.\n"
            "* *Merkmal verdoppeln* — dieselbe Bohrung ein zweites Mal, an einer "
            "anderen Stelle.\n"
            "* *Merkmal entfernen* — ohne Feld; *Übernehmen* genügt.\n\n"
            "Bohrung und Langloch können alle sechs. Ein Zapfen alles außer dem "
            "Ziehen — er ist Material und kein Loch. Eine Kugelfläche alles "
            "außer Drehen und Ziehen: Sie hat keine Lage, die sich drehen "
            "ließe, und keine Achse, entlang der ein Loch länger würde. Ein "
            "Kegel ebenfalls alles außer dem Ziehen, solange er für sich steht; "
            "sitzt er als Senkung über einer Bohrung, lässt er sich nicht "
            "versetzen, und warum, steht weiter unten. Eine Verrundung lässt "
            "ihren Radius ändern und sich ganz wegnehmen — auch in einem "
            "eingelesenen Modell. Ein Lufteinschluss lässt sich verschieben "
            "und entfernen; entfernt wird er mit Material gefüllt. Fläche, "
            "gerundete Seite, offene Kante, Ring und Gewinde können keine.\n\n"
            "**Was nicht geht, steht als Satz und nicht als graues Feld.** Bei "
            "einem Ring liest man: „Eine einzelne Ringfläche lässt sich nicht "
            "direkt ändern. Für eine andere Lage bewegen Sie den ganzen Körper. "
            "Für eine neue Rille oder einen Wulst können Sie einen Ring als "
            "Werkzeug verwenden.“ Das beendet "
            "das Suchen. Eine Lücke ließe offen, ob die Handlung fehlt oder "
            "vergessen wurde.\n\n"
            "**Wo mehrere gleichartige Merkmale am selben Körper sitzen**, steht "
            "an jeder Handlung ein Haken „Auf alle 4 gleichartigen anwenden“. "
            "Vier Bohrungen einer Lochreihe auf einmal aufzubohren ist ein "
            "Handgriff und wird auch einer: Es entsteht **eine** Transaktion, und "
            "ein Strg+Z nimmt sie zusammen zurück. Der Haken steht nur da, wo es "
            "Geschwister gibt — „Auf alle 1 anwenden“ wäre eine Frage ohne "
            "Unterschied.\n\n"
            "**An einer Fläche steht statt der sechs Absagen der Katalog.** Keine "
            "der Merkmalshandlungen gilt für eine Fläche; dafür setzen "
            "die passenden Bausteine an einer Fläche an. Der Knopf *Baustein "
            "einsetzen …* öffnet denselben Katalog wie der Weg über den "
            "Objektbaum.\n\n"
            "**Eine Kante ist das Dritte, was ein Klick treffen kann.** Der "
            "erste Klick wählt den Körper, der zweite die Kante — dieselbe "
            "Stufe wie bei einem Merkmal. Rechts stehen dann *Verrunden*, *Fase "
            "anbringen* und *Wulst anlegen* mit je einem Maß: Radius oder "
            "Breite eingeben, übernehmen. Das geht an einem eingelesenen Modell "
            "wie an einem selbst gezeichneten; am Netz besteht die Rundung aus "
            "geraden Stücken, die feiner sind, als eine Düse auflöst. Wer alle "
            "senkrechten Kanten meint, wählt die Gruppe im Dialog statt jeder "
            "Kante einzeln. Dasselbe gilt für *Fläche versetzen* und "
            "*Formschräge anstellen*: Beide arbeiten am eingelesenen Netz.\n\n"
            "**Sind zwei Merkmale markiert, steht dort ihr Abstand:** die "
            "Strecke von Mitte zu Mitte und die drei Achsabstände einzeln — "
            "„Abstand 30,00 mm · in X 0,00 · in Y 30,00 · in Z 0,00“. Die erste "
            "Zahl beantwortet, ob der Schlüssel dazwischenpasst, die drei "
            "anderen, wie weit die Schablone zu schieben ist. Es ist eine "
            "Auskunft und keine Handlung: kein Knopf darunter, kein Schritt im "
            "Verlauf. Bei drei markierten bleibt das Fenster stehen, wie es war "
            "— dann gibt es nicht eine Strecke, sondern drei.\n\n"
            "## Was mit einem Merkmal sonst noch geht\n\n"
            "**Entf trifft das Merkmal, nicht den Körper.** Ist eine Bohrung "
            "ausgewählt, nimmt die Taste die Bohrung weg und lässt das Teil "
            "stehen. Ohne gewähltes Merkmal löscht sie wie immer das Objekt.\n\n"
            "**Der Bewegungsgriff sitzt am gewählten Merkmal.** Wer eine Bohrung "
            "anklickt und *Bewegen* holt, findet die Pfeile an der Bohrung und "
            "nicht in der Mitte des Teils — bei einer Bohrung an ihrer Öffnung, "
            "denn auf halber Tiefe steckte der Griff im Material. Ein Zug daran "
            "wird *Merkmal verschieben* oder *Merkmal drehen*, nicht eine "
            "Verschiebung des ganzen Teils. Einen Skalierwürfel gibt es dort "
            "nicht: Eine Bohrung wächst über ihren Durchmesser, nicht über einen "
            "Hüllquader. Die Statuszeile sagt bei jedem Griff, was er bewegen "
            "wird.\n\n"
            "**Beim Ziehen ist zu sehen, wohin es geht.** Ein Zylinder in "
            "Durchmesser und Tiefe der Bohrung wandert mit; ein blasser bleibt "
            "an der Ausgangsstelle stehen, solange gezogen wird. Der Körper "
            "selbst ändert sich erst beim Loslassen.\n\n"
            "**Verschieben ist ein Schritt, nicht zwei.** Das Merkmal wird an "
            "der alten Stelle geschlossen und an der neuen angelegt — und die "
            "Kennung reist mit. Eine Passung, die auf diese Bohrung zeigt, "
            "behält ihren Bezug. Beim Verdoppeln ist es umgekehrt: Die Kopie "
            "bekommt eine eigene Kennung, das Original bleibt unberührt, und die "
            "Passung merkt nichts davon.\n\n"
            "**Drei Warnungen kann man dabei treffen**, und alle drei sind "
            "nützlich. Eine durchgehende Bohrung, die nach dem Versetzen nicht "
            "mehr durchgeht, sagt es. Ein Langloch, das an einem Ende über die "
            "Kante hinausragt, sagt es auch — selbst wenn seine Mitte tief im "
            "Material sitzt. Und eine Senkung über einer Bohrung lässt sich "
            "nicht allein versetzen — gleich ob die Bohrung durchgeht oder "
            "nicht: Die Senkung ist dort kein eigener Hohlraum, sondern geht in "
            "die Bohrung über, und versetzt zöge sie die Bohrung mit. Die "
            "Meldung nennt den Grund und den Weg: das Merkmal in der Mitte "
            "wählen, oder die Bohrung verschließen und beides neu anlegen — "
            "*Senken* ist eine eigene Operation.\n\n"
            "**Merkmale sind auch eine Analysekarte.** Das Werkzeug *Analyse* "
    ...
    Page(
        ...
        body=_(
            "Zwei Wege ändern das Modell wirklich und nicht bloß das Bild: "
            "*Bewegen* aus der Werkzeugzeile unter der Ansicht und **Färben** "
            "aus den Handlungen rechts am gewählten Körper oder an der "
            "gewählten Fläche. Beide halten das Versprechen des Verlaufs — jeder Zug "
            "und jede Zuweisung ist ein eigener Schritt, den Strg+Z einzeln "
            "zurücknimmt.\n\n"
            "**Bewegen zeigt den Griff im Bild:** drei Pfeile zum Verschieben, "
            "drei Ringe zum Drehen, ein Würfel zum gleichmäßigen Skalieren — "
            "beschriftet mit X, Y, Z und S.\n\n"
            "**Bewegt wird, was ausgewählt ist.** Ist das Teil gewählt, bewegt "
            "der Griff das Teil. Ist eine Bohrung darin gewählt, sitzt er an der "
            "Bohrung und bewegt die Bohrung — das Teil bleibt stehen. Die "
            "Statuszeile sagt bei jedem Griff, was er bewegen wird; was am "
            "Merkmal sonst noch anders ist, steht im Kapitel *Was Solidon im "
            "Modell erkennt*.\n\n"
            "**Wer lieber tippt als zieht, tippt.** Drei Knöpfe in der Leiste "
            "wählen, worum es geht — *Verschieben*, *Drehen*, *Skalieren* —, und "
            "daneben stehen die Zahlen dazu: X, Y, Z in Millimetern, ein Winkel "
            "in Grad, ein Faktor in Prozent oder gleich das Zielmaß. Die "
            "Eingabetaste im Feld wendet an; einen Knopf dafür gibt es nicht, "
            "denn der Zug am Griff hat auch keinen. Ist eine Fläche gewählt, "
            "bietet die Leiste nur *Verschieben* an — *Drehen* und *Skalieren* "
            "stehen grau da und nennen im Tooltip, warum.\n\n"
            "Beim Loslassen steht der Zug als *Verschieben*, *Drehen* oder "
            "*Skalieren* im Verlauf, mit Zahlen, die sich dort nachträglich "
            "ändern lassen wie jede andere.\n\n"
            "**Während des Zugs steht die Zahl über dem Bild.** Wer sie genau "
            "will, tippt sie: die erste Ziffer übernimmt den Zug, die "
            "Eingabetaste wendet genau den getippten Wert an — ohne Einrasten, "
            "denn wer tippt, meint es exakt —, und Esc verwirft den Zug "
            "ganz.\n\n"
            "**Und man sieht, wohin es geht.** Der Schatten zieht beim "
            "Verschieben mit; wer ein Teil anhebt, sieht ihn seitlich "
            "davonlaufen — das ist die einzige Auskunft über die Höhe, die ein "
            "Bild ohne Perspektive geben kann.\n\n"
            "**Über den Rand des Betts kommt am Griff niemand.** Schieben Sie "
            "einen Körper am Griff über die Druckfläche hinaus, holt Solidon "
            "ihn auf eine freie Stelle zurück — um die übrigen Körper derselben "
            "Platte herum. Ein getippter Wert dagegen wird ausgeführt, wie Sie "
            "ihn eingeben: Wer 150 mm nach rechts sagt, meint 150 mm, und der "
            "Prüfbericht sagt danach, ob das Teil noch auf dem Bett liegt.\n\n"
            "**Rasterfang und Winkelfang** runden jeden Zug auf den "
            "eingestellten Schritt. Beide stehen hinter dem Knopf mit dem "
            "Raster, und beide stehen ab Werk auf null: Ein Fang, den niemand "
            "eingestellt hat, verschluckt sonst jeden kleinen Zug. Beim Drehen "
            "greift stattdessen ein Magnet — in der Nähe eines Vielfachen von "
            "45 Grad rastet der Winkel kurz ein und gibt beim Weiterziehen "
            "wieder frei. Ein Bogen im Bild wächst dabei mit der Drehung und "
            "bleibt beim Einrasten stehen, damit man das Einrasten sieht und "
            "nicht nur an der Zahl abliest.\n\n"
            "**Ist eine Fläche gewählt, sitzt der Griff auf der Fläche.** Ein "
            "Zug an ihr versetzt die Fläche in ihrer Richtung, und die "
            "Nachbarwände wachsen mit (*Fläche versetzen*) — aus dem 20-mm-Klotz "
            "wird ein 25-mm-Klotz, keine verschobene Kiste. Was quer zur Fläche "
            "gezogen wird, verfällt: eine Fläche kennt nur vor und zurück. Das "
            "geht an einem eingelesenen Modell wie an einem selbst gezeichneten, "
            "und bewegt wird genau die Fläche, die Sie angeklickt haben — an "
            "einer Treppe bleiben die übrigen Stufen stehen.\n\n"
            "Der Würfel skaliert gleichmäßig — für ein genaues Zielmaß gibt es "
            "*Auf Maß bringen*, für achsweises Verzerren den Dialog von "
            "*Skalieren*. Und wer zwei Teile aneinandersetzen will, zieht nicht "
            ...
            "Fläche, auf die man zeigt. Für eine Fläche ist der kürzeste Weg, "
            "sie anzuklicken — der Eintrag steht dann rechts, und der Dialog "
            "kennt sie schon. Eine gerundete Seite, der Bogen eines Buchstabens "
            "etwa, nimmt ihr Filament auf demselben Weg.\n\n"
            "Gewählt wird ein **Filament**, keine Nummer: mit Namen und Farbe, "
            "aus dem eigenen Filamentlager oder gleich neu angelegt. Ganz oben steht, "
            "was der Körper schon trägt — meistens ist das die Antwort. Beim "
            "3MF-Export wird daraus der Filamentwechsel für den Drucker; ein "
            "Teil ohne eigenes Filament behält die Farbe des Körpers.\n\n"
            "Das **Filamentlager** öffnen Sie auf der Startseite oder über *Bearbeiten*. "
            "Jede Spule hat ihren eigenen Restbestand, auch wenn zwei gleich heißen. "
    ...
    Page(
        ...
        body=_(
            ...
            "nennt sie: liegend, quer oder schräg zur Schichtung. Wer die "
            "Fläche schon vor Augen hat, muss sie nicht in dieser Liste "
            "wiedererkennen: Rechtsklick darauf im Fenster oder im "
            "Objektbaum, *Auf dieser Fläche zeichnen*, fertig.\n\n"
            "**Die Werkzeuge und ihre Tasten:** Linie `L`, Kreis `C`, Bogen `A`, "
            "Punkt `P`, Kurve `S`, Vieleck `V`, Langloch `G`, Trimmen `T`. Vieleck, "
            "Langloch, Lochkreis und Lochraster entstehen aus je zwei Klicks: Mitte "
            "und Ecke beim Vieleck, die Mitten der beiden runden Enden beim Langloch, "
            "Mitte und erstes Loch beim Lochkreis, erstes und gegenüberliegendes Loch "
            "beim Lochraster; Eckenzahl, Breite, Anzahl, Spalten, Zeilen und "
            "Lochdurchmesser stehen daneben in der Leiste. Die Ziffern `1`, `2` und "
            "`3` wechseln direkt zwischen XY, XZ und YZ. `Esc` schaltet zurück aufs "
            "Auswählen und bricht ein angefangenes Element ab. Die Linie läuft als "
            "Zug weiter — das Ende ist der Anfang der nächsten. Eine Kurve sammelt, "
            "bis Sie sagen, dass sie fertig ist: Doppelklick, Eingabetaste, oder noch "
            "einmal auf den letzten Punkt klicken.\n\n"
            "**Alle Formen entstehen im Bild.** Auch das Rechteck (`R`), der "
            "Lochkreis und das Lochraster kommen als Zeichnung mit Bedingungen "
            "herein, nicht als Punkthaufen, und sind danach bemaßbar wie selbst "
            "Gezeichnetes; ein Menü mit festen Maßen gibt es nicht mehr.\n\n"
            "**Sehen, wählen, ziehen.** Maus und Tastatur fahren die Ansicht "
            "wie im Hauptfenster — was dort steht, gilt hier unverändert. "
            "Wer dabei dreht, bleibt gedreht — die Ansicht schwenkt beim "
            "Betreten einmal senkrecht auf die Zeichenebene und dann nicht "
            "mehr von selbst. *Einpassen* (`Pos1`) holt alles zurück ins "
            ...
            "Klicks zählt — „A parallel B“ ist nicht „B parallel A“. "
            "**Eine gesetzte Bedingung nimmt ein zweiter Klick auf "
            "denselben Knopf zurück**; er steht gedrückt, solange sie "
            "gilt. Ein Rechtsklick auf einen Punkt zeigt, was an ihm "
            "hängt, und nimmt es einzeln weg. `Entf` "
            ...
            "nach dem ersten Klick ein Maßfeld scharf, direkt am Zeiger und "
            "nicht in der Leiste: Länge "
            "oder Durchmesser "
            "eintippen, Eingabetaste — die Richtung kommt vom Zeiger, die "
            "Zahl aus dem Feld, und sie bleibt als Bedingung stehen. Am Kreis "
            "steht neben dem Feld Ø oder R: Ein Klick tauscht Durchmesser gegen "
            "Radius, und die Wahl gilt in jedem Kreisfeld der Anwendung. "
            ...
            "Ort. Es gibt sechzehn: Abstand, Radius, Durchmesser, Winkel, "
            "Deckung, Waagerecht, Senkrecht, Parallel, Rechtwinklig, "
            "Tangential, Gleich groß, Mittelpunkt, Konzentrisch, "
            "Symmetrisch, Fest und Referenzmaß, das mitmisst ohne zu halten. "
            "Was zur Auswahl nicht "
            ...
            "Y-Achse. *Hilfslinie* (`X`) macht aus einer Linie eine, die "
            ...
            "mit ins Bild.\n\n"
            "![](figure:sketch-uses)\n\n"
            "**Zum Schluss sagen Sie, was daraus wird.** *Hochziehen* und "
            "*Abtragen* stehen direkt an der fertigen Kontur; der Knopf *Fertig* "
            "klappt alle Arten auf, jede mit einem Satz dazu: extrudieren, als "
            ...
            "aufspannen. Was gerade nicht geht, sagt warum. *Verwerfen* verlässt "
            "den Modus, und die Statuszeile nennt den Weg zurück.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "**Weg 3 — ein Modell aus Text oder Bild aufbereiten.** Der "
            "mitgelieferte Ablauf erzeugt es mit TripoSG in einem lokalen "
            "ComfyUI. Was zurückkommt, ist eine Oberfläche und keine "
            "Konstruktion. Sie kommt durch die Reparaturkette, und Bohrungen "
            "entstehen danach als eigene Schritte — nicht dadurch, dass man "
            "das Netz vermisst.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "verschmolzen (*Weich verschmelzen* aus den Handlungen rechts, "
            "sobald die Körper gewählt sind); dann "
    ...
    Page(
        ...
        body=_(
            ...
            "darunter hängt. Auch das nachträgliche Ändern ist rücknehmbar: "
            "Strg+Z legt den vorigen Wert zurück, wie bei jedem anderen "
            "Schritt.\n\n"
            "**Mehrere Schritte lassen sich zugleich wählen** — Strg oder "
            "Umschalt beim Klicken. Genau das ist der Ausschnitt, den ein "
            "eigener Baustein bekommt (*Eigene Bausteine*), und ohne "
            "Auswahl gilt der ganze Stapel.\n\n"
            "**Löschen geht auch**, und es ist rücknehmbar wie alles "
            "hier: Der Eintrag steht im Kontextmenü der Liste und in der "
            "Leiste darunter. Weil ein gelöschter Schritt die trifft, die "
            "auf seinem Ergebnis aufbauen, ist er die eine Stelle mit "
            "einer Nachfrage — sie nennt die betroffenen Schritte und den "
            "Rückweg über Strg+Z. Sonst gibt es hier keine "
            "Sicherheitsabfragen.\n\n"
            "**„Diesen Schritt ändern“** steht auch am Merkmal selbst, im "
            "Kontextmenü in der Ansicht und im Objektbaum: der Weg vom "
            "Ergebnis zurück zum Schritt, ohne die passende Zeile im Verlauf "
            "zu suchen. Der Objektbaum gruppiert dafür, was aus einem "
            "Baustein entstanden ist, unter dessen Namen — sechs "
            "Verrundungen bleiben so bei ihrem Einhänger und nicht in einer "
            "flachen Liste.\n\n"
            ...
            "Bei einer angeklickten Bohrung sagt der Dialog dazu, zu welcher "
            "Normgröße der gemessene Durchmesser passt — und wo keine passt, "
            "fragt er, statt eine zu erfinden."
        ),
    ),
    Page(
        key="parameters",
        ...
        body=_(
            ...
            "*Parameter anlegen*, Name und Wert eintragen.\n\n"
            "**Und so kommt er in ein Maß.** Neben jedem Zahlenfeld steht ein "
            "Knopf **fx**. Er schaltet das Feld um: aus steht eine Zahl mit "
            "Drehknöpfen, an steht ein Ausdruck. Erst dann nimmt das Feld "
            "`=@breite/2` an — das Gleichheitszeichen macht aus dem Feld einen "
            ...
            "Liste steht *Breite*, im Ausdruck `@breite`. Die Vorschlagsliste "
            "zeigt den richtigen; wer sie benutzt, muss den Unterschied nie "
            "kennen.\n\n"
            "**Grenzen, Einheit und Ausdruck lassen sich nachträglich "
            "ändern.** Rechtsklick auf den Parameter, *Ändern …* — "
            "und das ist rücknehmbar wie jede andere Änderung. Eine zu eng "
            "gesetzte Obergrenze klemmt ein Feld sonst, ohne ein Wort zu "
            "sagen.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "Fläche anklicken, Baustein wählen, Größe wählen. Ohne einen "
            "gewählten Körper bleibt *Einfügen* gesperrt und nennt am Knopf, "
            "woran es liegt — durchsehen lässt sich der Katalog trotzdem, und "
            "ohne gewählten Baustein sagt er auch das.\n\n"
            "**Nach dem Einfügen steht der Baustein sofort im Bild** — auf der "
            "gewählten Fläche oder, wenn keine gewählt ist, oben auf dem "
            "Körper, mit Maßlinien zu den Kanten und einem Griff. Der Griff "
            "verschiebt ihn, ein Klick auf eine andere Stelle setzt ihn dorthin "
            "um, und die Maße lassen sich auch eintippen. Erst *Übernehmen* "
            "fügt ihn ein; Escape geht zurück zu den Werten.\n\n"
            ...
            "nichts zu montieren.\n\n"
            "![](figure:part-hinge)\n\n"
            "**Lochwand-Einhänger** — ein bis sechs Haken direkt am Teil, "
            "im Raster einer SKÅDIS-Lochwand; eine Rückplatte gibt es nur "
            "auf Wunsch. Von oben in die Schlitze, dann herunterziehen: Eine "
            "federnde Rastzunge rastet dabei ein und hält das Teil auch fest, "
            "wenn jemand daran zieht. Zum Abnehmen muss sie durch den Schlitz "
            "niedergedrückt werden — wer das Teil oft abnimmt, schaltet sie "
            "ab und bekommt dafür den einfachen Einhänger zum Anheben und "
            "Abnehmen. Gedruckt wird er liegend, damit die Zunge über ihre "
            "Schichten federt.\n\n"
            ...
            "**Bolzenscharnier** — zwei Laschen um einen mitgedruckten "
            "Bolzen, dazwischen ein Spalt, den der Drucker offen lässt. Es "
            "kommt fertig beweglich von der Platte: nichts zusammenstecken, "
            "nichts einlegen. Der Spalt ist die Passung — *Spiel* stellt ihn "
            "ein, und er ist der Unterschied zwischen einem Gelenk und zwei "
            "verklebten Laschen.\n\n"
            ...
            "Rippe, Schlüsselloch, Kugellager einsetzen, Schraube, Gedruckte "
            "Mutter, gedrucktes Gewinde, Nutfeder, Wandhalter, "
            "Schnappverbindung, Passstift und Passbohrung, Schnappverbinder "
            "für eine Naht "
            ...
            "setzen …* unter *Erzeugen → Bausteine* macht daraus einen Schritt: an "
    ...
    Page(
        ...
        body=_(
            ...
            "**Wählen Sie zuerst im Verlauf, was mitgehen soll.** Mehrere "
            "Schritte lassen sich dort markieren — Strg oder Umschalt beim "
            "Klicken, wie überall —, und genau diese wandern in den Baustein. "
            "Ohne Auswahl gilt der ganze Stapel, und das ist der häufige Fall: "
            "Wer sein Teil gerade gebaut hat, meint ohnehin alles. Der "
            "Rezeptdialog schreibt in seine Kopfzeile, was er bekommen hat, "
            "damit diese Vorgabe nicht stillschweigend gilt.\n\n"
            ...
            "auf die etwas gesetzt wird. Beides ist Pflicht und nicht nur "
            "Angebot: Ohne mindestens ein freigegebenes Maß und mindestens "
            "eine freigegebene Stelle bleibt *Baustein anlegen* gesperrt, mit "
            "dem Satz, was fehlt.\n\n"
            ...
            "werden Datei, Katalogeintrag und Rechnung zusammen. Und wenn Sie "
            "das Projekt nicht mehr haben, aus dem er stammt — oder er als "
            "Datei zu Ihnen kam —, holt ihn *Zum Bearbeiten öffnen …* im "
            "Katalog zurück: Seine Schritte stehen wieder im Verlauf, und beim "
            "Speichern steht alles da, was Sie damals eingetragen haben. Ein "
            "eingelesener Baustein bleibt dabei als eingelesen gekennzeichnet. "
            "Ein Rezept "
    ...
    Page(
        key="exchange",
        summary=_(
            "Einen eigenen Baustein weitergeben und einen fremden übernehmen — "
            "über eine Datei, nicht über ein Konto."
        ),
        title=_("Bausteindateien austauschen"),
        body=_(
            "Bausteine wechseln ausschließlich als Datei den Besitzer. Solidon "
            "stellt keine öffentliche Bibliothek bereit, lädt nichts hoch und "
            "braucht dafür weder Konto noch Netzverbindung. Sie entscheiden "
            "selbst, auf welchem Weg Sie eine Datei weitergeben. Die Datei "
            "trägt die Endung `.solidon-part` und ist am Namen und am Symbol "
            "als Solidon-Datei zu erkennen.\n\n"
            "**Exportieren beginnt im Bausteinkatalog** (*Datei → "
            "Bausteinkatalog …*, Strg+K). Wählen Sie einen eigenen Baustein und "
            "drücken Sie *Baustein als Datei weitergeben …*. Solidon legt die "
            "vollständige Bausteindatei samt Autor und Lizenz am gewählten "
            "Ort ab.\n\n"
            "**Nur eigene Bausteine lassen sich als eigene Arbeit ausgeben.** "
            "Mitgelieferte oder importierte Bausteine behalten ihre Herkunft, "
            "ihren Autor und ihre Lizenz. Neu speichern macht fremde Arbeit "
            "nicht zu Ihrer.\n\n"
            "**Die Lizenz sagen Sie im Klartext, nicht als Kürzel.** Der "
            "Dialog bietet drei Möglichkeiten an, und sie heißen, was sie "
            "bedeuten: *Gemeinfrei — jeder darf alles, ohne Bedingung*, "
            "*Namensnennung — mein Name muss dabeistehen*, und *Namensnennung, "
            "und Abwandlungen unter derselben Lizenz*. Wer die dritte wählt, "
            "verlangt, dass ein anderer seine Verbesserung ebenso weitergibt "
            "wie er selbst. Ihr Name daneben ist frei gewählt — ein Kürzel "
            "genügt, und niemand prüft ihn.\n\n"
            "**Die Datei trägt Daten, niemals ausführbaren Quelltext.** Sie "
            "enthält das Rezept aus registrierten Schritten und Werten sowie "
            "die Angaben, die zur verlustfreien Wiederherstellung nötig sind. "
            "Erforderliche eingebettete Modelldaten dürfen lokal mitreisen; "
            "Solidon prüft Größe, Aufbau und Integrität vor der Übernahme.\n\n"
            "**Hereinnehmen geht denselben Weg zurück.** Im Katalog steht "
            "*Baustein aus Datei hinzufügen …*; der Dialog nimmt eine Bausteindatei "
            "entgegen. Geht sie "
            "durch, sagt die Zeile „Eingelesen. Der Baustein steht im "
            "Katalog.“ — ab da benutzen Sie ihn wie jeden anderen.\n\n"
            "**Import und Export benutzen dieselbe Prüfung.** Findet sie etwas, "
            "steht der Grund im Klartext "
            "da — welches Feld fehlt, welcher Wert nicht zulässig ist, welche "
            "Operation unbekannt.\n\n"
            "**Ein importierter Baustein steht dauerhaft im lokalen Katalog.** "
            "Seine Herkunft bleibt dort sichtbar. Bei CC BY muss jede "
            "Weitergabe den ursprünglichen Autor nennen; bei CC BY-SA muss "
            "eine abgeleitete Fassung zusätzlich unter derselben Lizenz "
            "weitergegeben werden.\n\n"
            "**Bei gleichem Namen gewinnt Ihrer.** Heißt der eingelesene "
            "Baustein wie einer, den Sie schon haben, bleibt Ihrer stehen, und "
            "der importierte bekommt einen abgeleiteten Namen daneben. Eine Datei von "
            "außen schreibt Ihren Werkzeugkasten nicht um — auch dann nicht, "
            "wenn sie es versucht.\n\n"
            "**Alles bleibt offline.** Weder die Datei noch Autor, Lizenz oder "
            "Herkunft werden an RS Digital übertragen."
        ),
    ),
    Page(
        key="print",
        ...
        body=_(
            ...
            "der Projektkopfzeile ändern. Der Wechsel gilt nur diesem Projekt; "
            "Filamente, Farben und ihre eigenen Druckwerte bleiben erhalten. "
            "**Die Düse steht daneben** — ihr Durchmesser entscheidet, welche "
            "Maschine die Übergabe im Slicer wählt.\n\n"
            ...
            "Bambu Studio, ElegooSlicer, Creality Print) verlangt Drucker- und "
            "Prozessprofil "
            ...
            "Bei mehreren Platten bekommt die Orca-Familie alle gewählten in "
            "einer Datei — ein Fenster statt eines je Platte —, und die Teile "
            "liegen dort im Raster, wie der Slicer seine Platten selbst anlegt; "
            "PrusaSlicer und Cura kennen eine Platte je Datei und bekommen je "
            "eine. "
            ...
            "Nach einer erfolgreichen Ausgabe können Sie **Filament abziehen**. "
            "Solidon-Schätzungen und im G-Code geplante Mengen sind gekennzeichnet. "
    ...
    Page(
        ...
        body=_(
            ...
            "dann nicht passt, wird nicht weggelassen, sondern gemeldet — und "
            "besteht der Körper aus losen Teilen, ein Schriftzug etwa, bietet "
            "der Prüfbericht an, ihn in seine Teile zu zerlegen und gleich "
            "auszurichten: ein Klick, und die Buchstaben liegen auf den "
            "Platten.\n\n"
            ...
            "abmacht. Das gilt auch um eine Bohrung herum: Bleibt zwischen ihr "
            "und der Wand um sie weniger Material, als das Filament trägt, "
            "steht das im Prüfbericht — gemessen am fertigen Teil, nicht am "
            "Schritt, in dem gebohrt wurde.\n\n"
            "![](figure:wall)\n\n"
            ...
            "Programme, die eines von beiden verlangen.\n\n"
            "**Vor dem Schreiben zeigt der Export, was der Prüfbericht gefunden "
            "hat** — eine dünne Wand, eine verletzte Passung. Sie entscheiden, "
            "ob die Datei trotzdem entsteht: *Trotzdem exportieren* ist die "
            "Vorgabe, denn Format, Ordner und Name sind da schon gewählt, und "
            "ein Bericht ist keine Sperre.\n\n"
            "**Ordner, Format und Namensschema merkt sich Solidon je Projekt.** "
            "Der nächste Export beginnt dort, wo der letzte aufgehört hat. "
            "Entstehen mehrere Dateien, steht das Namensmuster mit seinen "
            "Platzhaltern im Namensfeld des Dateidialogs und lässt sich dort "
            "ändern — ein Name ohne Klammern ist ein Name, einer mit Klammern "
            "ein Muster.\n\n"
            "**Zum Herzeigen gibt es GLB.** Nicht zum Drucken — die Slicer lesen es "
            "nicht —, sondern zum Verschicken: Farben und Name reisen mit, das Teil "
            "kommt maßstabsgetreu in Metern an, und der Empfänger dreht es im "
            "Browser, ohne irgendetwas zu installieren.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "**Bearbeiten → Automatisch teilen** nimmt auch die Suche ab. Die "
            ...
            "Wer die Ebene lieber eintippt als zeigt, nimmt *Teilen* aus den "
            "Handlungen rechts am gewählten Körper und trägt Achse und Position ein. "
    ...
    Page(
        ...
        body=_(
            ...
            "**Der Weg dorthin ist ein Prüfstück.** Der Bausteinkatalog "
            "(*Datei → Bausteinkatalog*, `Strg+K`) führt unter *Kalibrierung* "
            "den *Toleranz-Testkörper*: eine Reihe von Zapfen und "
            ...
            "hilft der Variantengenerator: *Bearbeiten → Varianten erzeugen* "
    ...
    Page(
        ...
        title=_("Der Chat"),
        body=_(
            "Der Chat ruft dieselben Operationen auf, die auch im Fenster "
            "stehen — rechts in der Auswahl und im Menü *Erzeugen*; er ist "
            "eine zweite Hand am selben Werkzeug und kein zweiter Weg an ihm "
            "vorbei.\n\n"
            ...
            "**Drei Regeln hat er mitbekommen**, und sie stehen nicht zur "
            "Verhandlung: Bausteine vor selbst gebauten Formen, benannte "
            "Parameter vor eingetippten Zahlen — und **fragen vor raten**. "
            "Wenn Ihre Anfrage zwei Lesarten hat, kommt eine Rückfrage und "
            "kein Ergebnis.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "Das ist der wichtigste Satz zu diesem Weg. Ein generiertes Netz "
            ...
            "**Der mitgelieferte Ablauf setzt auf TripoSG.** Quelltext und "
            "Modellkarte weisen die MIT-Lizenz aus; die vollständige "
            "Lizenzkette der Gewichte und der eingebundenen Modelle wird "
            "geprüft. Geholt wird beides erst bei der Einrichtung in "
            "ComfyUI. Andere Modelle haben eigene "
            "Bedingungen, die für die jeweils eingesetzte Fassung vor dem "
            "Einsatz geprüft werden müssen.\n\n"
            "**Das Erzeugte wird eine Quelle, keine Operation.** Ein Generator "
            "ist keine Funktion: dieselbe Anfrage liefert nach einem "
            "Modellwechsel etwas anderes. Die Bytes liegen deshalb im Projekt "
            "wie eine hineingezogene Datei, und der Stapel darüber ist der "
            "gewöhnliche — *Modell laden*, dann *Reparieren*. Anfrage und "
    ...
    Page(
        key="extras",
        summary=_(
            "Die drei Programme, die Solidon benutzen kann — was jedes bringt, und "
            "was nach dem Installieren noch zu tun ist."
        ),
        title=_("Zusätzliche Programme einrichten"),
        body=_(
            "**Keines davon ist Pflicht.** Ohne alle drei läuft der ganze "
            ...
            "jeder der üblichen — PrusaSlicer, SuperSlicer, OrcaSlicer, "
            "ElegooSlicer, Bambu Studio, Creality Print, Cura. Sind mehrere "
            "installiert, wählt man in den "
            ...
            "Und sie misst, **wie schnell dieser Rechner es tut**. Wenn Ollama "
            ...
            "selbst unterstützt AMD-Grafikkarten über **ROCm** unter Linux und Windows "
            "— welche Karten, steht in seiner Unterstützungsliste, und ob es auf "
            "diesem Rechner trägt, sagt die Werkzeugprobe. **IPEX-LLM** und "
            "**OpenVINO** sind eigene Installationen mit eigenen Hardwaregrenzen und "
            ...
            "laden. Beides legt Solidon selbst hinein: In der Liste der "
            "zusätzlichen Programme steht in der Zeile von ComfyUI *Knoten "
            "und Modell einrichten …*.\n\n"
            "**Der kurze Weg führt über den Erzeugungsdialog selbst.** *Datei → "
            "Modell erzeugen* sagt, wie weit der Generator ist, und "
            "unterscheidet drei Lagen: Es läuft keiner, es läuft einer ohne "
            "die Knoten, oder alles ist bereit. In der Mitte steht der Knopf "
            "zur Einrichtung direkt daneben.\n\n"
            "Der Dialog findet ComfyUI selbst. Die **Desktop-Version** von "
            "comfy.org trägt ein, wohin sie installiert wurde. Die tragbare "
            "Version entpacken Sie selbst; steht sie an einer ungewöhnlichen "
            "Stelle, geben Sie den Ordner an, in dem `custom_nodes` und "
            "`main.py` liegen.\n\n"
            ...
            "OpenCASCADE hält Flächen und Kanten einzeln bearbeitbar; V-HACD "
            "zeigt, wo ein Körper von selbst auseinanderfällt. Beide liegen im "
            "Installationspaket bei. Wer Solidon aus den Quellen startet, findet "
            "sie in derselben Liste und installiert sie von dort."
        ),
    ),
    Page(
        key="surfaces",
    ...
    Page(
        key="labels",
        summary=_(
            "Text auf ein Teil oder als eigener Schriftzug — welche Schrift "
            "trägt, und was die Düse daraus macht."
        ),
        title=_("Beschriften"),
        body=_(
            ...
            "Zweifarbendruck mit zwei Dateien. Eine angeklickte Fläche trägt "
            "Ort und Richtung selbst ein.\n\n"
            "**Acht Schriften stehen zur Wahl, und alle acht reisen mit dem "
            "Programm.** Ein Projekt sieht damit auf jedem Rechner gleich aus. "
            "Sechs davon sind gerade — je eine serifenlose, eine mit Serifen "
            "und eine mit festen Zeichenbreiten, in zwei Sippen —, dazu eine "
            "runde und eine geschriebene. Die sechs geraden gibt es in vier "
            "Schnitten: normal, fett, kursiv sowie fett und kursiv; die Wahl "
            "liegt hinter *Weitere Einstellungen*. Fett trägt bei gleicher "
            "Höhe dickere Striche und bleibt lesbar, wo der normale Schnitt "
            "schon verschmiert. Die runde und die geschriebene Schrift gibt es "
            "nur in einem Schnitt; die Wahl steht bei ihnen grau.\n\n"
            "**Ob eine Schrift trägt, entscheidet die Düse, nicht die "
            "Schrift.** Dieselbe Schreibschrift, die mit einer feinen Düse "
            "sauber kommt, läuft mit einer groben zu. Solidon misst die "
            "Strichbreite des gesetzten Textes gegen die schmalste Bahn, die "
            "Ihr Drucker legt, und sagt, ab welcher Höhe sie trägt — statt "
            "sie zu drucken und zulaufen zu lassen. Gesperrt wird nichts: Wer "
            "ein Schild nur ansehen will, darf es klein haben.\n\n"
            "**Die Buchstaben stehen danach im Objektbaum wie jedes andere "
            "Merkmal.** Ihre geraden Seiten als Flächen, ihre gerundeten — der "
            "Bogen des D, der Mantel des o — als *Gerundete Seite*. Beide "
            "nehmen ein eigenes Filament an: Fläche anklicken, rechts "
            "*Filament auf eine Fläche*, fertig. Ein Schriftzug, dem Sie ein "
            "Filament zugewiesen haben, behält es auch dann, wenn er für das "
            "Druckbett in seine Buchstaben zerlegt wird.\n\n"
            "**Und wie jeder andere Schritt bleibt die Schrift änderbar.** "
            "Text, Größe, Schrift und Tiefe stehen im Verlauf; ein Doppelklick "
            "auf den Schritt öffnet sie wieder, und ein Tippfehler wird "
    ...
    Page(
        ...
        body=_(
            ...
            "Operationen auf, die auch im Fenster stehen — rechts in der "
            "Auswahl und im Menü *Erzeugen*.\n\n"
            ...
            "Eines geht nicht durch die Leitung, und das ist Absicht: alles, "
            "was wie ein Dateipfad aussieht. Es würde bedeuten, dass ein "
            "fremdes Programm bestimmt, was auf diesem Rechner gelesen "
            "wird.\n\n"
    ...
    Page(
        ...
        body=_(
            "**Diese Fassung ist eine vollständige, befristete Demo.** Bis "
            "einschließlich 30. Oktober 2026 ist Solidon ohne Lizenzschlüssel "
            "und Geräteaktivierung vollständig freigeschaltet. Die Statuszeile "
            "nennt die verbleibenden Tage von Anfang an. Nach dem Stichtag "
            "startet diese Demo nicht mehr; Ihre Projekte bleiben erhalten.\n\n"
            "**Die spätere Verkaufsversion startet ohne Testphase.** Ohne "
            "Lizenzschlüssel und Geräteaktivierung bleibt dort alles Lesende "
            "offen — Modelle öffnen, ansehen, vermessen —, nur die vier "
            "schreibenden Handlungen brauchen die Freischaltung: eine Änderung "
            "am Modell, ein Export, die Übergabe an den Slicer und der Chat. "
            "Eine Testphase kann in einer späteren Fassung angeboten werden.\n\n"
            ...
            "**Wie viele Rechner zugleich?** Mit einer privaten Lizenz einer, "
            "mit einer gewerblichen zwei — etwa Arbeitsplatz und Notebook. Welche "
            "Art ein Schlüssel hat, steht unter *Hilfe → Über Solidon*.\n\n"
            "**Beim Rechnerwechsel zuerst: Diesen Rechner deaktivieren.** "
            "Solidon gibt den Geräteplatz frei und entfernt die lokale "
    ...
    Page(
        ...
        body=_(
            ...
            "Solidon sagt beim Öffnen, was mit ihr nicht stimmt, statt eine "
            "leere Szene aufzubauen: Sie ist leer, sie ist mitten im Satz "
            "abgeschnitten, sie ist trotz der Endung keine STL oder kein "
            "3MF-Archiv, sie führt null Dreiecke, oder ihre Koordinaten ergeben "
            "keine Ausdehnung. In den ersten vier Fällen steckt fast immer ein "
            "abgebrochener Download — dann hilft, sie noch einmal zu laden. "
            "Kommt statt des Modells die Fehlerseite eines Servers an, sieht "
            "das genauso aus. Bei null Dreiecken lohnt der Blick ins "
            "Ursprungsprogramm: Meistens war beim Exportieren nichts "
            "ausgewählt. Jede dieser Meldungen trägt den Knopf *Andere Datei "
            "wählen*, der gleich in die Dateiauswahl führt.\n\n"
            ...
            "**STEP ist ausgegraut.**\n"
            "Das Format bewahrt Flächen und Kanten einzeln, und dafür braucht "
            "es einen Körper, der sie noch hat. Aktivieren Sie beim Anlegen der "
            "Grundform *Flächen und Kanten später bearbeiten*; derselbe Haken "
            "steht auch im Dialog des Schritts. Hat ein späterer Schritt daraus "
            "feste Dreiecke gemacht, hilft nur die Reihenfolge: die Schritte ab "
            "dort zurücknehmen, exportieren und den Rest neu aufbauen. Solidon "
            "nennt den Schritt, der im Weg steht. Verrunden und Fase brauchen "
            "das nicht: Sie arbeiten auch an einem eingelesenen Netz — die "
            "Rundung besteht dort aus geraden Stücken, die feiner sind, als "
            "eine Düse auflöst.\n\n"
            "**Die Handlungen rechts sind gesperrt.**\n"
            "Hält die Kette an einem Schritt an — weil eine Zerlegung nicht "
            "aufgeht oder ein Teil auf kein Bett passt —, nimmt Solidon keinen "
            "neuen Schritt dahinter an: Er würde nie gerechnet. Der Grund steht "
            "an jedem Knopf und nennt den Schritt; der Weg weiter steht im "
            "Prüfbericht, und ein Versuch trotzdem zeigt gleich dessen "
            "Auswege.\n\n"
            ...
            "kommt erst beim Export. Bei sehr detailreichen Modellen hilft es, "
            "früh zu vereinfachen — die Dreieckszahl steht im Objektbaum. Beim Öffnen "
            "eines Projekts legt sich eine Ladeanzeige über die Ansicht, damit "
            "die leere Szene nicht wie ein leeres Projekt aussieht.\n\n"
            "**Ein grauer Knopf sagt, warum er grau ist.** Wo etwas gesperrt "
            "ist, steht der Grund am Knopf selbst — als Kurzhilfe für die Maus, "
            "in der Statuszeile für den Blick nach unten und in der "
            "Beschreibung für den Bildschirmleser. „Wählen Sie links in der "
            "Liste einen Baustein“ ist eine Auskunft; ein grauer Knopf ohne sie "
            "ist ein Fehler in Solidon.\n\n"
            ...
            "**Während der Demo fragt Solidon von selbst.** Nach 15 Minuten "
            "Arbeit mit jeder neuen Version — gezählt werden nur Minuten, in denen Sie etwas "
            ...
            "Klick geht nichts hinaus. Die Karte erscheint pro Version nur einmal, "
            "auch wenn Sie sie stehen lassen. *Nein danke* und eine gesendete "
            "Antwort gelten für diese Version; bei einer neuen Version beginnt "
            "die Nutzungszeit wieder bei null."
        ),
    ),
    Page(
        key="glossary",
        ...
        body=_(
            ...
            "**Merkmal** — eine Stelle im Netz, in der Solidon eine bekannte "
            "Form wiedererkannt hat: eine Bohrung, ein Zapfen, eine Rundung, "
            "eine Fläche. Aus zehntausend Dreiecken wird damit wieder etwas, "
            "das man anklicken und ändern kann.\n\n"
            ...
            "**Skizze (Zeichnung)** — ein ebener Umriss aus Linien, Kreisen und "
            "Bögen. Aus ihr wird ein Körper, und sie bleibt danach änderbar: "
            "eine Linie verschieben heißt, das Teil ändern.\n\n"
            "**Bedingung** — eine Regel, die die Zeichnung zusammenhält: zwei "
            ...
            "**Hochziehen (extrudieren)** — einen Umriss senkrecht zu seiner "
            "Ebene hochziehen, bis ein Körper daraus wird. Der übliche Weg von "
            "der Zeichnung zum Teil; unter *Erzeugen → Aus Skizze erzeugen* "
            "heißt diese Art *Grundform hochziehen*, und andere Programme "
            "nennen ihn Extrudieren.\n\n"
            "**Tasche** — dasselbe nach innen: Der Umriss wird aus einem "
            "vorhandenen Körper herausgeschnitten, statt einen neuen "
            "aufzusetzen.\n\n"
            "**Profil** — der geschlossene Umriss, aus dem ein Körper "
            "entsteht. Nicht dasselbe wie das Material- oder Druckerprofil, "
            "das Werte liefert.\n\n"
            "**Kurve** — eine weiche Linie durch mehrere gesetzte Punkte, für "
            "Formen, die weder gerade noch kreisrund sind. In anderen "
            "Konstruktionsprogrammen heißt sie Spline.\n\n"
            "**Hilfslinie** — eine Linie, die Bedingungen trägt, aber "
            "selbst keinen Körper bildet. Die Mittellinie, an der etwas "
            "symmetrisch hängt, soll nicht mitgedruckt werden.\n\n"
