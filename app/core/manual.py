...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "**Unter Prüfbericht und Chat liegen die Operationen zur Auswahl**, "
            "sobald ein oder mehrere Körper gewählt sind — in einer eigenen "
            "Karte unter der von Bericht und Chat. Vorn stehen die, die zur "
            "Auswahl passen: bei zwei Körpern *Vereinigen*, *Abziehen* und "
            "*Schnittmenge*, bei einem einzelnen *Bohrung setzen*, *Aushöhlen* "
            "und *Teilen*, an einer angeklickten Bohrung *Bohrung ändern*, "
            "*Senken* und *Bohrung verschließen*. Die Suche darunter findet "
            "alle weiteren. Der Bausteinkatalog und das Merkmalsfenster "
            "bleiben eigene Bereiche.\n\n"
            "**Ganz rechts steht das Merkmalsfenster**, über die volle Höhe: die "
            "Maße der Stelle, die Sie angeklickt haben, und was sich damit tun "
            "lässt. Es lässt sich abziehen und woanders hinstellen, und "
            "*Ansicht → Merkmal* blendet es aus. Was darin steht, sagt das "
    ...
    Page(
        ...
        body=_(
            ...
            "## Das Merkmalsfenster\n\n"
            "Wer ein Merkmal anklickt — im Bild oder im Objektbaum —, findet "
            "seine Maße im Fenster *Merkmal*. Es steht ganz rechts und über die "
            ...
            "sich auch, und *Ansicht → Merkmal* blendet es ganz aus. Es folgt "
