...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        title=_("Die Tauschbörse"),
        body=_(
            "Die Mutternfalle, die Sie für Ihren Drucker gebaut haben, passt "
            "auch auf den Drucker von jemand anderem. Die Tauschbörse ist der "
            "Ort, an dem so etwas den Besitzer wechselt — als Datei, die Sie "
            "hochladen und ein anderer herunterlädt.\n\n"
            "**Hinausgeben beginnt im Bausteinkatalog** (*Datei → "
            "Bausteinkatalog …*, Strg+K). Wählen Sie den Baustein aus und "
            "drücken Sie *Veröffentlichen …*. Solidon schreibt eine "
            "Börsendatei, und die Statuszeile sagt danach: „Gespeichert. Diese "
            "Datei können Sie auf die Tauschbörse laden.“ Der Knopf schickt "
            "also nichts fort — er legt eine Datei an, und was damit geschieht, "
            "entscheiden Sie im Browser.\n\n"
            "**Nur eigene Bausteine lassen sich veröffentlichen.** Die "
            "mitgelieferten gehören nicht Ihnen, und ein Baustein, der aus "
            "einem fremden Projekt zu Ihnen kam, gehört dem, der ihn gebaut "
            "hat. Steht der Knopf grau, sagt die Zeile daneben, welcher der "
            ...
            "**Was in der Datei steht, ist das Rezept und nicht das Modell.** "
            "Sie trägt die Schritte, aus denen der Baustein entsteht, samt "
            "ihren Werten — kein Programm, keine ausführbare Datei. Der "
            "Empfänger rechnet sie auf seinem Rechner neu, mit seinem Material "
            "und seinen Toleranzen, und bekommt damit ein Teil, das zu *seinem* "
            "Drucker passt und nicht zu Ihrem.\n\n"
            "**Hereinnehmen geht denselben Weg zurück.** Im Katalog steht "
            "*Aus Datei einlesen …*; der Dialog heißt *Veröffentlichten "
            "Baustein einlesen* und nimmt eine Börsendatei entgegen. Geht sie "
            "durch, sagt die Zeile „Eingelesen. Der Baustein steht im "
            "Katalog.“ — ab da benutzen Sie ihn wie jeden anderen.\n\n"
            "**Geprüft wird zweimal, und beide Male dasselbe.** Solidon sieht "
            "die Datei an, bevor es sie annimmt, und der Server tut es, bevor "
            "er sie ausliefert. Beide lesen dieselbe Liste dessen, was erlaubt "
            "ist, damit Ihnen nicht die eine Seite abnimmt, was die andere "
            "wegwirft. Findet die Prüfung etwas, steht der Grund im Klartext "
            "da — welches Feld fehlt, welcher Wert nicht zulässig ist, welche "
            "Operation unbekannt.\n\n"
            "**Ein übernommener Baustein bleibt bei dem Projekt, mit dem er "
            "kam.** Im Katalog steht er als „veröffentlichter Baustein — kam "
            "aus der Tauschbörse und bleibt bei diesem Projekt“, und das ist "
            "wörtlich gemeint: Er wandert nicht in Ihren Bausteinordner, und "
            "in einem anderen Projekt ist er nicht da. Wollen Sie ihn "
            "dauerhaft haben, legen Sie ihn aus dem Katalog heraus als eigenen "
            "Baustein neu an — dann gehört er Ihnen, und Sie dürfen ihn auch "
            "weitergeben.\n\n"
            "**Bei gleichem Namen gewinnt Ihrer.** Heißt der eingelesene "
            "Baustein wie einer, den Sie schon haben, bleibt Ihrer stehen, und "
            "der neue bekommt einen abgeleiteten Namen daneben. Eine Datei von "
            "außen schreibt Ihren Werkzeugkasten nicht um — auch dann nicht, "
            "wenn sie es versucht.\n\n"
            "**Ihre Mailadresse braucht die Börse einmal, und sie speichert "
            "sie nicht.** Beim Hochladen bestätigen Sie über einen Link, dass "
            "die Adresse Ihnen gehört; danach bleibt auf dem Server nur ein "
            "Prüfwert, aus dem sich die Adresse nicht zurückrechnen lässt. "
            "Niemand kann Sie darüber anschreiben, auch der Betreiber nicht.\n\n"
            "**Heben Sie die Bestätigungsmail auf.** Sie trägt einen zweiten "
            "Link, und der ist der einzige Weg, mit dem Sie Ihren Beitrag "
            "später selbst zurückziehen können — weil die Börse Sie sonst "
            "nicht als seinen Urheber erkennt. Zurückgezogen wird der Baustein "
            "gelöscht, und die Verknüpfung zu Ihrer Adresse geht mit ihm."
        ),
    ),
    Page(
        key="print",
    ...
    Page(
        ...
        body=_(
            ...
            "ist der gewöhnliche — *Modell laden*, dann *Reparieren*. Anfrage und "
