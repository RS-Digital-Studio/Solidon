...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "Es gibt weitere lokale Wege, und Solidon richtet sie nicht ein: "
            "**IPEX-LLM**, **ROCm** und **OpenVINO** sind jeweils eigene "
            "Installationen mit eigenen Hardwaregrenzen und Fallen; keiner "
            "dieser Wege wird von Ollama selbst angeboten. Wer einen davon "
            "nutzen will, muss ihn passend zu seinem Rechner prüfen; wer nicht, "
            "nimmt einen Schlüssel für ein gehostetes Modell. Beides ist "
            "vertretbar, und alles außer dem Chat läuft ohne beides.\n\n"
