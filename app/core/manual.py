...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "`A`, Punkt `P`, Spline `S`, Trimmen `T`. Die Ziffern `1`, `2` "
    ...
    Page(
        ...
        body=_(
            ...
            "**Extrudieren (hochziehen)** — einen Umriss senkrecht zu seiner "
            "Ebene aufziehen, bis ein Körper daraus wird. Der übliche Weg von "
            "der Zeichnung zum Teil.\n\n"
