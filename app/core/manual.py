...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "dass ein Teil nicht auf die Platte passt — früher als jeder "
    ...
    Page(
        ...
        body=_(
            ...
            "3. **Werkzeuge prüfen.** Der wichtigste Schritt: Ob ein Modell "
            "Werkzeuge wirklich aufruft, sagt weder seine Größe noch sein "
            "Anbieter. Die Probe macht einen echten Zug. Sagt sie „schreibt "
            "seine Aufrufe als Text“, antwortet der Chat zwar, führt aber nichts "
            "aus — dann hilft ein anderes Modell.\n\n"
            ...
            "Der Dialog sucht ComfyUI an den üblichen Stellen. Findet er es "
            "nicht, gehört der Ordner angegeben — gesucht wird der, in dem "
            "`custom_nodes` und `main.py` liegen. Dann laufen vier Schritte: "
            "Knoten hinlegen, den TripoSG-Quelltext holen, zwei Stellen darin "
            "richten, drei Pakete nachziehen. Und auf Wunsch das Modell, rund "
            "7,5 GB.\n\n"
