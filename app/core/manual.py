...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "einem Ring liest man: „Ein Ring gehört zu dem, was er umschließt — "
            "einer Rille um eine Bohrung, einem Wulst um einen Zapfen. Versetzt "
            "man ihn allein, läge die Rille neben ihrer Bohrung.“ Das beendet "
            ...
            "nicht gibt; bis dahin hilft nur, die Kante neu zu verrunden. Alle "
            "übrigen Absagen sind endgültig und liegen an der Geometrie.\n\n"
