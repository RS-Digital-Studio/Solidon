...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "seine Auswahl für dieses Projekt. Unterschiedliche Materialien und "
            ...
            "eine Warnung, springt die Ansicht von selbst auf den Bericht. Beim "
            ...
            "*Aushöhlen* und *Teilen*, an einer angeklickten Bohrung *Bohrung "
            "ändern*, *Senken* und *Bohrung verschließen*. Die Suche darunter "
            "findet alle weiteren; der Bausteinkatalog bleibt ein eigener "
            "Bereich. Das Fenster lässt sich abziehen und woanders hinstellen, "
            "und *Ansicht → Auswahl* blendet es aus. Was darin steht, sagt das "
            "Kapitel über die Merkmale.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "Dreiecken.\n\n"
            "**Elf Arten, und der Name sagt die Lage:**\n\n"
            ...
            "ist das Durchgangsloch für M5. Darunter steht je Handlung eine "
            "Gruppe aus Feldern und einem Knopf.\n\n"
            ...
            "die Vorschau, sobald das Tippen kurz ruht; erst der Knopf macht "
            "daraus einen Schritt im Verlauf.\n\n"
            "**Fünf Handlungen gibt es**, und welche davon dasteht, hängt von "
            "der Art ab:\n\n"
            ...
            "Bohrung und Zapfen können alle fünf. Eine Kugelfläche alle außer "
            "Drehen — sie hat keine Lage, die sich drehen ließe, gedreht sähe "
            "sie aus wie vorher. Ein Kegel kann sie ebenfalls, solange er für "
            "sich steht; sitzt er als Senkung über einer Bohrung, lässt er sich "
            "nicht versetzen, und warum, steht weiter unten. Fläche, offene "
            "Kante, Ring und Verrundung können keine.\n\n"
            ...
            "vergessen wurde.\n\n"
            "**Und zwei dieser Sätze sagen „noch nicht“ statt „nie“.** Den "
            "Radius einer erkannten Verrundung zu ändern und eine Verrundung "
            "wieder wegzunehmen sind beides sinnvolle Handlungen, die es heute "
            "nicht gibt; bis dahin hilft nur, die Kante neu zu verrunden. Die "
            "übrigen Hinweise erklären, welche Bearbeitung für die gewählte "
            "Merkmalsart möglich ist.\n\n"
            ...
            "Unterschied.\n\n"
            "**An einer Fläche steht statt der fünf Absagen der Katalog.** Keine "
            ...
            "**Zwei Warnungen kann man dabei treffen**, und beide sind nützlich. "
            "Eine durchgehende Bohrung, die nach dem Versetzen nicht mehr "
            "durchgeht, sagt es. Und eine Senkung über einer Bohrung lässt sich "
    ...
    Page(
        ...
        body=_(
            ...
            "aus dem Menü. Beide halten das Versprechen des Verlaufs — jeder Zug "
            ...
            "gezogen wird, verfällt: eine Fläche kennt nur vor und zurück.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "zurücknehmen, das gewünschte Werkzeug anwenden und den Rest neu "
            "aufbauen. Solidon nennt den Schritt, der im Weg steht.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "der Zeichnung zum Teil; im Menü heißt er *Grundform hochziehen*, "
            "und andere Programme nennen ihn Extrudieren.\n\n"
