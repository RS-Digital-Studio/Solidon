...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "selbst, auf welchem Weg Sie eine Datei weitergeben.\n\n"
            "**Exportieren beginnt im Bausteinkatalog** (*Datei → "
            "Bausteinkatalog …*, Strg+K). Wählen Sie einen eigenen Baustein und "
            "drücken Sie *Baustein als Datei weitergeben …*. Solidon zeigt vor dem "
            "Speichern Autor und Lizenz und legt die vollständige "
            "Bausteindatei am gewählten Ort ab.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "Gewichte stehen unter der MIT-Lizenz und werden erst bei der "
            "Einrichtung in ComfyUI geholt. Andere Modelle haben eigene "
