...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "Skizze ist flach. Mit *Auswählen* greift ein Zug an einem Punkt "
            ...
            "Prüfbericht. Bei einer kleinen Skizze liegt der Rahmen "
            "außerhalb des Bildes; einmal herauszoomen holt ihn herein.\n\n"
            "![](figure:sketch-uses)\n\n"
