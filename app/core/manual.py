...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "Passungsleiter* entsteht eine Reihe von Zapfen und Bohrungen mit "
            "abgestuftem Spiel — 0,10 bis 0,40 mm in Schritten. Einmal "
            "drucken, durchprobieren, den Wert merken, der saugend passt.\n\n"
            "![](figure:part-fit-ladder)\n\n"
