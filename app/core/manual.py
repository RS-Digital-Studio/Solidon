...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "exakte Körper, mit echten Flächen und Kanten. Dazu OBJ und PLY, "
            "für Programme, die eines von beiden verlangen.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "Diese Operationen brauchen echte Kanten aus dem zweiten "
            "Konstruktionskern, und er reist mit der Installation mit — hier "
            "geht es um die **Art des Körpers**, nicht um ein fehlendes "
            "Programm. Entweder war der Körper nie exakt: Dann hilft der Haken "
            "*Exakt (B-Rep)* im Anlegen-Dialog, nachträglich auch im Dialog des "
            "Schritts. Oder eine Netz-Operation dazwischen hat aus einem "
            "exakten Körper ein Netz gemacht — dann hilft kein Haken, sondern "
            "nur die Reihenfolge: die Schritte ab dort zurücknehmen, die "
            "gewünschte Operation anwenden und den Rest neu aufbauen. Solidon "
            "nennt in beiden Fällen, welcher zutrifft.\n\n"
            ...
            "vereinfachen — die Dreieckszahl steht im Objektbaum. Beim Öffnen "
