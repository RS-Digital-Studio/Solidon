...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "Rad. Ein Anschlag ist ein Schritt, gehalten wiederholt es sich. "
            "Der Unterschied zum Zoom: Der fährt bis vor das Teil, der Flug "
            "geht hindurch. Die Tasten kommen erst an, wenn die Ansicht den "
            "Fokus hat — ein Klick hinein genügt; wer aus einem Eingabefeld "
            "kommt und gleich W drückt, schreibt ein W.\n\n"
