...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "![](figure:window)\n\n"
            "**Oben die Werkzeugzeile.** Links darin, was nur hinsieht — "
            "Messen, Schnitt, Explosion —, rechts, was das Modell wirklich "
            "ändert: *Bewegen*, *Bemalen* und *Zeichnen*. Das letzte macht die "
            "Mitte zur Zeichenfläche, solange gezeichnet wird, und Escape "
            "kommt daraus zurück wie aus jedem anderen Werkzeug.\n\n"
    ...
    Page(
        ...
        body=_(
            ...
            "**Der Knopf *Zeichnen* in der Werkzeugzeile** ist der Anfang. Die "
            "Mitte des Fensters wird zur Zeichenfläche, und was daraus "
            ...
            "schließt.\n\n"
            "**Fertige Umrisse gibt es unter *Grundform*:** Rechteck (`R`), "
            "Langloch, Kreis, Sechseck — und die beiden, die sonst Handarbeit "
            ...
            "Freiheitsgrade frei“ heißt, dass vier Dinge noch nicht "
            ...
            "![](figure:sketch-uses)\n\n"
            "**Am Ende: *Fertig*.** Dann fragt Solidon, was aus der Zeichnung "
            "werden soll, und zeigt die fünf Arten mit einem Satz dazu: "
    ...
    Page(
        ...
        body=_(
            ...
            "Grundkörper hergibt, wird gezeichnet — der Knopf *Zeichnen* in "
            "der Werkzeugzeile, beschrieben im Kapitel davor.\n\n"
