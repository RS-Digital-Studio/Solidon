...
INTRODUCTION: Final[tuple[Page, ...]] = (
    ...
    Page(
        ...
        body=_(
            ...
            "**Unter Prüfbericht und Chat liegen die Körperoperationen**, sobald "
            "ein oder mehrere Körper gewählt sind. Vereinigen, Abziehen und "
            "Schnittmenge stehen vorn; die Suche findet alle weiteren passenden "
            "Operationen. Merkmale und Bausteine bleiben in ihren eigenen "
            "rechten Bereichen.\n\n"
