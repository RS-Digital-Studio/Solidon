...
`app.py` (Einstiegspunkt, §38) · `main_window.py` (**8 400 Zeilen** — das
...
`viewport.py` (**6 700 Zeilen** — §18, §2.9) · `overlay.py` (Zonen über der
...
`sketch_editor.py` (**3 900 Zeilen** — §30.1, Stufe zwei)
