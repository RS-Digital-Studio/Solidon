...
erzeugtes Musikbett aus `tools/make_longform_video.py`.

Für alle drei Videos:

- Kategorie: Wissenschaft & Technik
- Sprache von Titel und Beschreibung: Deutsch
- Videosprache: Deutsch
- Lizenz: Standard-YouTube-Lizenz
- Kommentare: aktiviert
- Link in den ersten beiden Zeilen: `https://solidon3d.de/`
- Kein Hinweis auf künstliche oder veränderte reale Inhalte nötig: gezeigt
  wird ausschließlich die eigene Anwendung und daraus berechnete Geometrie
- Veröffentlichungsrhythmus: ein langes Video pro Woche; die kurzen
  Pressebelege bleiben im Zweitagesrhythmus dazwischen
...
Wir starten mit einem leeren Projekt und konstruieren einen druckbaren Montagehalter: Rechteck skizzieren, Plattenstärke und Lochabstand als Projektmaße anlegen, zwei M4-Senkbohrungen aus dem Katalog setzen, eine verrundete Versteifungsrippe ergänzen und die Variante über einen einzigen Parameter ändern.

Dabei siehst du auch, wie Verlauf, Live-Vorschau, Rückgängig, Drucklage und Prüfbericht zusammenspielen. Das Ergebnis bleibt bearbeitbar, statt nur als starres Endnetz vorzuliegen.
...
Von einem leeren Projekt zum vollständigen Elektronikgehäuse: parametrischer B-Rep-Grundkörper, verrundete Kanten, offene Schale mit einstellbarer Wandstärke, vier M3-Heat-Set-Buchsen, Kabeldurchführung mit Zugentlastung, Versteifungsrippen, Standfüße, passender Deckel und Rastnasen.

Zum Schluss werden Gehäuse und Deckel auf dem Druckbett angeordnet und die Breite von 120 auf 140 mm geändert. Alle davon abhängigen Bausteine folgen dem neuen Maß, ohne dass die Konstruktion neu aufgebaut werden muss.
...
## Nächste sinnvolle Langvideos

1. Rollenhalter mit zwei Achsen, verstifteten Seitenwänden und variabler
   Rollenbreite
2. Kabelstation mit drei Clipgrößen, Beschriftung und zwei M4-Wandbohrungen
3. Zweifarbiger Tür- oder Werkstattschild-Aufbau mit Schrift als Geometrie
4. Kalibriersatz für Spiel, Wandstärke und Überhang aus einem Projekt
5. Fremdes STL anpassen: Merkmale erkennen, messen, verschieben und für den
   eigenen Drucker teilen
