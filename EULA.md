...
Stand: 12. September 2026 · Fassung 1.7
...
**Zur Demo-Version:** Sie ist unentgeltlich, vollständig und **zeitlich
...
Zum Missbrauchsschutz sind je Lizenzschlüssel **fünf gültig signierte
Aktivierungsversuche pro UTC-Kalendertag** möglich. Dabei zählen auch Versuche,
die wegen eines bereits aktiven anderen Rechners oder eines gesperrten
Schlüssels abgewiesen werden. Das Tageslimit beginnt um 00:00 Uhr UTC neu.
Deaktivierungen zählen nicht gegen dieses Tageslimit.
...
Beim Rechnerwechsel deaktivieren Sie den bisherigen Rechner in Solidon; dafür
braucht er einmal Verbindung zum Aktivierungsdienst. Ist er verloren oder
defekt, setzt der Support den Platz nach Prüfung der Bestellnummer zurück.
...
Ihnen bereits zustehen. Sie dürfen Modelle, Projektdateien und exportierte
Dateien nur insoweit nutzen und weitergeben, wie Rechte Dritter und die
nachfolgenden Regeln zu mitgelieferten Bausteinen und Beispielen nicht
entgegenstehen. Dazu gehört insbesondere die Lizenz einer importierten
Quelle, einer lokal übernommenen Bausteindatei oder eines verwendeten
generativen Modells. Durch Bearbeiten, Speichern oder Exportieren verschwinden
solche Rechte und Namensnennungspflichten nicht. Mit einer Bausteindatei reisen
ihre Angaben zu Herkunft, Autor und Lizenz; sie sind vor einer Weitergabe oder
gewerblichen Nutzung zu beachten. Solidon3D überträgt Ihnen keine Rechte, die
weder Sie noch RS Digital besitzen.

Wer einen gedruckten Gegenstand im eigenen Namen verkauft oder anderweitig in
Verkehr bringt, muss seine Rolle und die Produktsicherheit dieses Gegenstands
nach den konkreten Umständen selbst bestimmen und erfüllen. Die bloße Nutzung
von Solidon3D macht RS Digital nicht automatisch zum Hersteller jedes späteren
Ausdrucks. Unberührt bleibt eine gesetzliche Verantwortlichkeit von RS Digital
für die Software, mitgelieferte digitale Konstruktionsunterlagen und eigene
Produkt- oder Sicherheitszusagen.

Für die von RS Digital mitgelieferten Bausteine gilt: Wenn darin eine
Mutternfalle, ein Gewinde oder ein Filmscharnier aus der Bibliothek steckt,
bleibt daran keine zusätzliche Einschränkung von uns hängen. Die Bibliothek
steht unter der MIT-Lizenz; wir erheben keinen Anspruch und verlangen für das
gedruckte oder exportierte Ergebnis keine Nennung. Bei lokal importierten
Bausteindateien gilt dagegen die darin ausgewiesene Lizenz. Fehlt eine
Lizenzangabe, gewährt Solidon3D dadurch keine Weitergabe- oder Nutzungsrechte;
diese Rechte sind vor einer Weitergabe gesondert zu klären.

An den elf in `app/examples/LICENSE` einzeln benannten Beispielprojekt-/
Vorschaupaaren behält RS Digital das Urheberrecht. Die dort beigefügte
Nutzungsfreigabe erlaubt Ihnen, die Beispiele zu öffnen, lokal zu kopieren,
zu bearbeiten, zu drucken und zu exportieren. Gedruckte Gegenstände sowie
eigene, individuell bearbeitete digitale Ergebnisse dürfen Sie privat und
gewerblich nutzen und weitergeben. Die unveränderten ursprünglichen P3D- und
SVG-Dateien dürfen ohne gesonderte Erlaubnis nicht als Vorlagen oder Sammlung
weitergegeben werden. Fremdimporte bleiben nach ihren eigenen Rechten zu
beurteilen.

## 4a. Demo-Version

Eine als **Demo** bezeichnete Version (Versionsnummer 0.x) überlassen wir
...
keine dauerhaft nutzbare Version.
...
Programm öffnen. Unterstützte spätere Fassungen halten den dokumentierten
Migrationsweg offen; eine Zusage für jede denkbare künftige Fassung ist das
nicht.
...
* **Keine Weitergabe der Datei.** Geben Sie stattdessen die Adresse
  ...
  nicht mehr startet.
* **Haftung.** Es gelten die Nummern 10 und 11 wie für die Vollversion — auch
  für die unentgeltliche Demo, und ohne Abstriche bei Leben, Körper und
  Gesundheit.
...
## 4. Freischaltung der Verkaufsversion

Wenn die Vollversion angeboten wird, startet sie zunächst **ohne zusätzliche
Testphase**. Eine weitere 0.x-Demo oder eine spätere Testphase kann
ausdrücklich angeboten werden; aus diesem Vertrag entsteht darauf kein
Anspruch.

Ohne vollständige Freischaltung bleibt alles Lesende offen: eigene Projekte
öffnen, drehen, messen, Prüfbericht und Schichtanalyse ansehen. Für alles, was
ein Projekt **ändert oder ein Ergebnis herausgibt**, ist die Freischaltung
erforderlich: Operationen anwenden, exportieren, an den Slicer übergeben und
den Chat benutzen. Bei neu ausgegebenen Verkaufsschlüsseln gehören dazu
Kaufcode und passendes Geräte-Zertifikat; der Kaufcode allein öffnet diese
Handlungen nicht. Für bereits ausgegebene Bestandsschlüssel genügt weiterhin
der gültige Kaufcode.

## 5. Updates

Im Kaufpreis enthalten sind **alle Aktualisierungen der Hauptversion 1** —
also jede Version 1.0, 1.1, 1.2 und so fort. Ob es eine Version 2 geben wird
...
* Die Software oder Teile davon **weiterverkaufen, veröffentlichen oder
  verbreiten** — ausgenommen die Weitergabe nach Nummer 6 und die in Nummer 3
  ausdrücklich erlaubte Nutzung separat lizenzierter Bausteine, Beispiele und
  eigener Ergebnisse.
...
* Die Software **der Regierung Russlands oder in Russland niedergelassenen
  juristischen Personen, Organisationen oder Einrichtungen** verkaufen,
  liefern, bereitstellen oder für sie nutzen; dasselbe gilt für Belarus und
  für jede Person, gegen die Sanktionen der Europäischen Union bestehen.
  Software für Industriedesign und Fertigung, darunter CAD, ist in Anhang
  XXXIX der Verordnung (EU) Nr. 833/2014 ausdrücklich erfasst (Art. 5n
  Abs. 2b). Mit der Nutzung bestätigen Sie, keine solche Person zu sein und
  die Software nicht an eine solche weiterzugeben.

Diese Beschränkungen gelten nicht, soweit zwingendes Recht oder die Lizenz
eines fremden Bestandteils die Handlung erlaubt. Insbesondere dürfen Sie
dynamisch gebundene LGPL-Bibliotheken austauschen und die dafür notwendigen
Untersuchungen, Änderungen und Rückentwicklungen vornehmen. Solidon3D darf
eine ordnungsgemäß ersetzte LGPL-Bibliothek nicht allein wegen der Ersetzung
blockieren.
...
**Für diese fremden Bestandteile gehen deren Lizenzbedingungen diesen Bestimmungen vor.**
Keine Regel dieses Vertrags beschränkt Rechte, die eine
solche Lizenz oder zwingendes Recht einräumt.
...
Bibliothek durch eine eigene, veränderte Version zu ersetzen. Bei der
Windows-Installation liegen die betreffenden Dateien dafür unverschlüsselt im
Programmordner. Die Installation nennt die genauen Versionen, vollständigen
Lizenztexte, Bezugsorte des korrespondierenden Quelltexts und die für einen
Austausch erforderlichen Hinweise. Dieselben Angaben erhalten Sie auf Anfrage
an <support@solidon3d.de>.
...
Projektablage im Netz und keine Telemetrie. Verbindungen entstehen nur auf
den folgenden, sichtbaren Wegen:
...
* **Druckbarkeit.** Die Schichtanalyse ist Solidon3Ds eigene Rechnung und
  nicht die Ihres Slicers. „Druckbar“ bedeutet ausschließlich, dass ein Modell
  nach den gewählten geometrischen und drucktechnischen Kriterien für die
  weitere Verarbeitung geeignet erscheint. Der Begriff sagt insbesondere
  nichts über Tragfähigkeit, Lebensmittelechtheit, elektrische Sicherheit,
...
**Nicht Gegenstand der Zweckbestimmung** sind die Auslegung, Prüfung oder
Freigabe sicherheitskritischer Bauteile — insbesondere für Medizin und
Dentaltechnik, Fahrzeuge, Luft- und Raumfahrt, persönliche Schutzausrüstung,
sonstige Schutzvorrichtungen, Gas- oder Druckanwendungen, elektrische
Sicherheit oder tragende Konstruktionen. Ob ein konkretes Teil für seinen realen Zweck sicher und
rechtlich zulässig ist, muss dafür fachkundig geprüft und, soweit erforderlich,
nach den einschlägigen Vorschriften bewertet werden.

## 11. Haftung

Wir haften unbeschränkt bei Vorsatz und grober Fahrlässigkeit — auch unserer
gesetzlichen Vertreter und Erfüllungsgehilfen —, bei arglistigem Verschweigen
eines Mangels, für Schäden aus der Verletzung des Lebens, des Körpers oder der
Gesundheit sowie nach dem Produkthaftungsgesetz.

Bei einfacher Fahrlässigkeit — auch unserer gesetzlichen Vertreter und
Erfüllungsgehilfen — haften wir nur bei der Verletzung einer wesentlichen
Vertragspflicht, also einer Pflicht, deren Erfüllung die ordnungsgemäße
Durchführung des Vertrags überhaupt erst ermöglicht und auf deren Einhaltung
Sie regelmäßig vertrauen dürfen. In diesem Fall ist die Haftung auf den
