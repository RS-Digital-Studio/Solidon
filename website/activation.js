...
(() => {
  ...
  const translations = {
    de: {
      ...
      error_rate_limit: "Der Aktivierungsdienst hat weitere Anfragen vorübergehend begrenzt. Versuchen Sie es später erneut oder wenden Sie sich an den Support.",
      error_rate_limit_client: "Über diesen Internetanschluss kamen zu viele Anfragen in kurzer Zeit. Versuchen Sie es in 15 Minuten erneut.",
      error_rate_limit_global: "Der Aktivierungsdienst hat gerade sehr viele Anfragen erhalten. Versuchen Sie es in 15 Minuten erneut.",
      error_rate_limit_daily: "Für diesen Lizenzschlüssel wurden heute bereits fünf neue Geräteplätze vergeben. Versuchen Sie es nach dem nächsten Tageswechsel um 00:00 Uhr UTC erneut oder wenden Sie sich an den Support.",
    ...
    en: {
      ...
      error_rate_limit: "The activation service has temporarily limited further requests. Try again later or contact support.",
      error_rate_limit_client: "Too many requests were sent from this internet connection in a short time. Try again in 15 minutes.",
      error_rate_limit_global: "The activation service has just received a large number of requests. Try again in 15 minutes.",
      error_rate_limit_daily: "Five new device slots have already been allocated to this licence key today. Try again after the next day begins at 00:00 UTC or contact support.",
    ...
    es: {
      ...
      error_rate_limit: "El servicio de activación ha limitado temporalmente las solicitudes adicionales. Inténtelo más tarde o contacte con soporte.",
      error_rate_limit_client: "Se han enviado demasiadas solicitudes desde esta conexión a internet en poco tiempo. Inténtelo de nuevo en 15 minutos.",
      error_rate_limit_global: "El servicio de activación acaba de recibir muchas solicitudes. Inténtelo de nuevo en 15 minutos.",
      error_rate_limit_daily: "Hoy ya se han asignado cinco nuevos dispositivos a esta clave de licencia. Inténtelo cuando comience el día siguiente a las 00:00 UTC o contacte con soporte.",
    ...
    fr: {
      ...
      error_rate_limit: "Le service d’activation a temporairement limité les nouvelles demandes. Réessayez plus tard ou contactez l’assistance.",
      error_rate_limit_client: "Trop de demandes ont été envoyées depuis cette connexion internet en peu de temps. Réessayez dans 15 minutes.",
      error_rate_limit_global: "Le service d’activation vient de recevoir un grand nombre de demandes. Réessayez dans 15 minutes.",
      error_rate_limit_daily: "Cinq nouveaux emplacements d’appareil ont déjà été attribués à cette clé de licence aujourd’hui. Réessayez après le début du jour suivant à 00:00 UTC ou contactez l’assistance.",
    ...
    it: {
      ...
      error_rate_limit: "Il servizio di attivazione ha temporaneamente limitato le ulteriori richieste. Riprova più tardi o contatta l’assistenza.",
      error_rate_limit_client: "Sono state inviate troppe richieste da questa connessione internet in poco tempo. Riprova tra 15 minuti.",
      error_rate_limit_global: "Il servizio di attivazione ha appena ricevuto molte richieste. Riprova tra 15 minuti.",
      error_rate_limit_daily: "Oggi sono già stati assegnati cinque nuovi posti dispositivo a questa chiave di licenza. Riprova dopo l’inizio del giorno successivo alle 00:00 UTC o contatta l’assistenza.",
    ...
    pt: {
      ...
      error_rate_limit: "O serviço de ativação limitou temporariamente os pedidos adicionais. Tente novamente mais tarde ou contacte o suporte.",
      error_rate_limit_client: "Foram enviados demasiados pedidos a partir desta ligação à internet num curto período. Tente novamente daqui a 15 minutos.",
      error_rate_limit_global: "O serviço de ativação acabou de receber muitos pedidos. Tente novamente daqui a 15 minutos.",
      error_rate_limit_daily: "Hoje já foram atribuídos cinco novos lugares de dispositivo a esta chave de licença. Tente novamente depois do início do dia seguinte às 00:00 UTC ou contacte o suporte.",
